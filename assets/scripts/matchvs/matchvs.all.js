var MVS = function (e) {
    var t = {
        version: "SDK_RELMatchvs_V3.7.9.10",
        Game: {id: 0, appkey: ""},
        DEBUG: !1,
        IsWss: !1,
        IsNotice: !0,
        ...
        Config: {HEART_BEAT_INTERVAL: 3e3, MAXPLAYER_LIMIT: 100, MINPLAYER_LIMIT: 1},
        Host: {
            MAIN_URL: "@MAIN_URL",
...
MatchvsLog.openLog = function (e) {
    console.log("---- open log ----", e ? "(isDebug=true)" : "(isDebug=false)"), e && (MVS.DEBUG = !0), "undefined" == typeof wx ? (MatchvsLog.logI = console.info.bind(console, "[INFO][Matchvs] "), MatchvsLog.logE = console.error.bind(console, "[ERROR][Matchvs] "), MVS.DEBUG ? MatchvsLog.logD = console.log.bind(console, "[DEBUG][Matchvs] ") : MatchvsLog.logD = function () {
        ...
        console.info("[INFO][Matchvs] " + getNowFormatDate() + " " + this.toArray(arguments) + " " + t)
    }, MVS.DEBUG ? MatchvsLog.logD = function () {
        var t = "";
        try {
            throw new Error
        } catch (e) {
        ...
        console.log("[DEBUG][Matchvs] " + getNowFormatDate() + " " + this.toArray(arguments) + " " + t)
    ...
    e.ENGE_STATE = o, e.MvsState = function () {
        ...
        this.StateDoing = function () {
            ...
            return e < 0 ? e : (e = this.StateDoing()) < 0 ? e : r(o.IN_TEAM) ? -8 : r(o.IN_WATCH) ? -8 : r(o.IN_ROOM) ? -8 : 0
...
var format = function (t) {
    for (var r, e, o, s, i = 1, a = [].slice.call(arguments), n = 0, p = t.length, g = "", m = !1, l = !1, u = function () {
        return a[i++]
    }, c = function () {
        for (var e = ""; /\d/.test(t[n]);) e += t[n++], r = t[n];
        return 0 < e.length ? parseInt(e) : null
    }; n < p; ++n) if (r = t[n], m) switch (m = !1, "." == r ? (l = !1, r = t[++n]) : "0" == r && "." == t[n + 1] ? (l = !0, r = t[n += 2]) : l = !0, s = c(), r) {
        case"b":
            g += parseInt(u(), 10).toString(2);
            break;
        case"c":
            "string" == typeof (e = u()) || e instanceof String ? g += e : g += String.fromCharCode(parseInt(e, 10));
            break;
        case"d":
            g += parseInt(u(), 10);
            break;
        case"f":
            o = String(parseFloat(u()).toFixed(s || 6)), g += l ? o : o.replace(/^0/, "");
            break;
        case"j":
            g += JSON.stringify(u());
            break;
        case"o":
            g += "0" + parseInt(u(), 10).toString(8);
            break;
        case"s":
            g += u();
            break;
        case"x":
            g += "0x" + parseInt(u(), 10).toString(16);
            break;
        case"X":
            g += "0x" + parseInt(u(), 10).toString(16).toUpperCase();
            break;
        default:
            g += r
    } else "%" === r ? m = !0 : g += r;
...
function stringToUtf8ByteArray(e, t) {
    ...
    for (var o = [], s = 0, i = 0; i < e.length; i++) {
        ...
        a < 128 ? o[s++] = a : (a < 2048 ? o[s++] = a >> 6 | 192 : (55296 == (64512 & a) && i + 1 < e.length && 56320 == (64512 & e.charCodeAt(i + 1)) ? (a = 65536 + ((1023 & a) << 10) + (1023 & e.charCodeAt(++i)), o[s++] = a >> 18 | 240, o[s++] = a >> 12 & 63 | 128) : o[s++] = a >> 12 | 224, o[s++] = a >> 6 & 63 | 128), o[s++] = 63 & a | 128)
    }
    var n;
...
!function (e) {
    var t = {
        isNeedWSS: function () {
            return !!MVS.IsWss || ("undefined" != typeof wx || ("undefined" != typeof FBInstant || "undefined" != typeof BK))
        }, getWs: function () {
            return this.isNeedWSS() ? "wss://" : "ws://"
        }, getLiveUrl: function (e, t, r, o) {
            var s = "live=" + e.getAddr() + "&gameID=" + t + "&roomID=" + r + "&setID=" + o;
            return MVS.IsWss ? "wss://" + e.getWssproxy() + "/watch?" + s : "ws://" + e.getAddr()
        }, getHotelUrl: function (e) {
            return this.isNeedWSS() ? "wss://" + e.getWssproxy() + "/proxy?hotel=" + e.getAddr() : "ws://" + e.getAddr()
    ...
    var r = function () {
        ...
        return e.prototype.setInterval = function (e, t) {
    ...
    var o, t, r, s, i = !1, a = (o = ["C"], (t = function () {
    }).prototype.isInvailed = function (e) {
        for (var t = function (e) {
            e.length;
            var t = e.split("#");
            return 2 !== t.length ? "" : t[1]
        }(e), r = 0; r < o.length; r++) if (t === o[r]) return i = !0;
        return console.error("[游戏账户与渠道不匹配，请使用cocos账号登录Matchvs官网创建游戏]：(https://www.matchvs.com/cocos)"), !1
    }, t);
    e.AppKeyCheck = a, s = "", (r = e).CCAnalytics && (r.ccReport = new function () {
        this.init = function () {
            i && (r.CCAnalytics && r.CCAnalytics.init({
                appID: "673213760",
                appSecret: "fdfb6e64e71457866d7785414002c628",
                channel: "cocos_mvs",
                version: "1.0.0"
            }), r.CCAnalytics && r.CCAnalytics.onPause(!0), r.CCAnalytics && r.CCAnalytics.onResume(!0))
        }, this.login = function (e) {
            i && (s = e + "", __obj.CCAnalytics && obj.CCAnalytics.CAAccount.loginStart())
        }, this.loginRsp = function (e) {
            200 == e ? r.CCAnalytics && r.CCAnalytics.CAAccount.loginSuccess({userID: s}) : r.CCAnalytics && r.CCAnalytics.CAAccount.loginFailed()
        }, this.logout = function () {
            r.CCAnalytics && r.CCAnalytics.CAAccount.logout({userID: s})
        }
    })
    ...
    function g(r, e) {
        if (!n[r]) {
            ...
            var s = n[r] = {exports: {}};
            a[r][0].call(s.exports, function (e) {
                var t = a[r][1][e];
                return g(t || e)
            }, s, s.exports, i, a, n, p)
        }
    ...
    for (var m = "function" == typeof _require && _require, e = 0; e < p.length; e++) g(p[e]);
    return g
}({
        ...
        (function (global) {
            ...
            $jscomp.global = $jscomp.getGlobal(this), $jscomp.initSymbol = function () {
                ...
                if (o && Object.prototype.hasOwnProperty.call(e.data_, r)) for (var s = 0; s < o.length; s++) {
                    var i = o[s];
                    if (t != t && i.key != i.key || t === i.key) return {id: r, list: o, index: s, entry: i}
                }
            ...
            goog.global = this, goog.isDef = function (e) {
                ...
                if ((e = goog.getPathFromDeps_(e)) && e in goog.dependencies_._requires) for (var t in goog.dependencies_._requires[e]) if (!goog.isProvided_(t) && !goog.isDeferredModule_(t)) return !1;
                return !0
                ...
                for (function e(t) {
                    if (!(t in i.written || t in i.visited)) {
                        if (i.visited[t] = !0, t in i._requires) for (var r in i._requires[t]) if (!goog.isProvided_(r)) {
                ...
                for (var r = 0, o = goog.string.trim(String(e)).split("."), s = goog.string.trim(String(t)).split("."), i = Math.max(o.length, s.length), a = 0; 0 == r && a < i; a++) {
                    var n = o[a] || "", p = s[a] || "", g = RegExp("(\\d*)(\\D*)", "g"),
                        m = RegExp("(\\d*)(\\D*)", "g");
                    do {
                        var l = g.exec(n) || ["", "", ""], u = m.exec(p) || ["", "", ""];
                        if (0 == l[0].length && 0 == u[0].length) break;
                        r = 0 == l[1].length ? 0 : parseInt(l[1], 10);
                        var c = 0 == u[1].length ? 0 : parseInt(u[1], 10);
                        r = goog.string.compareElements_(r, c) || goog.string.compareElements_(0 == l[2].length, 0 == u[2].length) || goog.string.compareElements_(l[2], u[2])
                    } while (0 == r)
                }
                return r
            ...
            jspb.Map.prototype.loadFromArray_ = function () {
                ...
                for (var i = void 0, a = void 0; t.nextField() && !t.isEndGroup();) {
                    var n = t.getFieldNumber();
                    1 == n ? i = r.call(t) : 2 == n && (e.valueCtor_ ? (a = new e.valueCtor_, o.call(t, a, s)) : a = o.call(t))
                }
            ...
            },goog.userAgent.isDocumentMode = goog.userAgent.isDocumentModeOrHigher,goog.userAgent.DOCUMENT_MODE = (py = goog.global.document, qy = goog.userAgent.getDocumentMode_(), py && goog.userAgent.IE ? qy || ("CSS1Compat" == py.compatMode ? parseInt(goog.userAgent.VERSION, 10) : 5) : void 0),goog.userAgent.product = {},goog.userAgent.product.ASSUME_FIREFOX = !1,goog.userAgent.product.ASSUME_IPHONE = !1,goog.userAgent.product.ASSUME_IPAD = !1,goog.userAgent.product.ASSUME_ANDROID = !1,goog.userAgent.product.ASSUME_CHROME = !1,goog.userAgent.product.ASSUME_SAFARI = !1,goog.userAgent.product.PRODUCT_KNOWN_ = goog.userAgent.ASSUME_IE || goog.userAgent.ASSUME_EDGE || goog.userAgent.ASSUME_OPERA || goog.userAgent.product.ASSUME_FIREFOX || goog.userAgent.product.ASSUME_IPHONE || goog.userAgent.product.ASSUME_IPAD || goog.userAgent.product.ASSUME_ANDROID || goog.userAgent.product.ASSUME_CHROME || goog.userAgent.product.ASSUME_SAFARI,goog.userAgent.product.OPERA = goog.userAgent.OPERA,goog.userAgent.product.IE = goog.userAgent.IE,goog.userAgent.product.EDGE = goog.userAgent.EDGE,goog.userAgent.product.FIREFOX = goog.userAgent.product.PRODUCT_KNOWN_ ? goog.userAgent.product.ASSUME_FIREFOX : goog.labs.userAgent.browser.isFirefox(),goog.userAgent.product.isIphoneOrIpod_ = function () {
                ...
                for (var r = t ? goog.crypt.base64.byteToCharMapWebSafe_ : goog.crypt.base64.byteToCharMap_, o = [], s = 0; s < e.length; s += 3) {
                    var i = e[s], a = s + 1 < e.length, n = a ? e[s + 1] : 0, p = s + 2 < e.length, g = i >> 2,
                        m = (i = (3 & i) << 4 | n >> 4, n = (15 & n) << 2 | (m = p ? e[s + 2] : 0) >> 6, 63 & m);
                    p || (m = 64, a || (n = 64)), o.push(r[g], r[i], r[n], r[m])
                }
                return o.join("")
                ...
                for (o in r = {}, e) null != (t = e[o]) && (r[o] = "object" == typeof t ? jspb.Message.clone_(t) : t);
                return r
                ...
                var t = e.charCodeAt(0), r = e.charCodeAt(1), o = e.charCodeAt(2), s = e.charCodeAt(3),
                    i = e.charCodeAt(4), a = e.charCodeAt(5), n = e.charCodeAt(6);
                ...
                var e = this.bytes_, t = this.cursor_, r = e[t + 0], o = e[t + 1], s = e[t + 2], i = e[t + 3],
    ...
    5: [function (e, t, r) {
        ...
        o.exportSymbol("proto.stream.BookInfo", null, i), o.exportSymbol("proto.stream.BrigadeInfo", null, i), o.exportSymbol("proto.stream.CancelTeamMatchNotify", null, i), o.exportSymbol("proto.stream.CancelTeamMatchReq", null, i), o.exportSymbol("proto.stream.CancelTeamMatchRsp", null, i), o.exportSymbol("proto.stream.ChangeRole", null, i), o.exportSymbol("proto.stream.ChangeRoleRsp", null, i), o.exportSymbol("proto.stream.CmdId", null, i), o.exportSymbol("proto.stream.ConnDetailV2", null, i), o.exportSymbol("proto.stream.CreateFlag", null, i), o.exportSymbol("proto.stream.CreateRoom", null, i), o.exportSymbol("proto.stream.CreateRoomRsp", null, i), o.exportSymbol("proto.stream.CreateTeamReq", null, i), o.exportSymbol("proto.stream.CreateTeamRsp", null, i), o.exportSymbol("proto.stream.GetRoomDetailReq", null, i), o.exportSymbol("proto.stream.GetRoomDetailRsp", null, i), o.exportSymbol("proto.stream.GetRoomList", null, i), o.exportSymbol("proto.stream.GetRoomListExReq", null, i), o.exportSymbol("proto.stream.GetRoomListExRsp", null, i), o.exportSymbol("proto.stream.GetRoomListRsp", null, i), o.exportSymbol("proto.stream.GetTeamDetailReq", null, i), o.exportSymbol("proto.stream.GetTeamDetailRsp", null, i), o.exportSymbol("proto.stream.GetWatchDataReq", null, i), o.exportSymbol("proto.stream.GetWatchDataRsp", null, i), o.exportSymbol("proto.stream.GetWatchRoomsReq", null, i), o.exportSymbol("proto.stream.GetWatchRoomsRsp", null, i), o.exportSymbol("proto.stream.HeartbeatReq", null, i), o.exportSymbol("proto.stream.HeartbeatRsp", null, i), o.exportSymbol("proto.stream.JoinOpenNotify", null, i), o.exportSymbol("proto.stream.JoinOpenReq", null, i), o.exportSymbol("proto.stream.JoinOpenRsp", null, i), o.exportSymbol("proto.stream.JoinOverNotify", null, i), o.exportSymbol("proto.stream.JoinOverReq", null, i), o.exportSymbol("proto.stream.JoinOverRsp", null, i), o.exportSymbol("proto.stream.JoinRoomReq", null, i), o.exportSymbol("proto.stream.JoinRoomRsp", null, i), o.exportSymbol("proto.stream.JoinRoomType", null, i), o.exportSymbol("proto.stream.JoinTeamNotify", null, i), o.exportSymbol("proto.stream.JoinTeamReq", null, i), o.exportSymbol("proto.stream.JoinTeamRsp", null, i), o.exportSymbol("proto.stream.JoinTeamType", null, i), o.exportSymbol("proto.stream.JoinWatchRoomNotify", null, i), o.exportSymbol("proto.stream.JoinWatchRoomReq", null, i), o.exportSymbol("proto.stream.JoinWatchRoomRsp", null, i), o.exportSymbol("proto.stream.KickPlayer", null, i), o.exportSymbol("proto.stream.KickPlayerNotify", null, i), o.exportSymbol("proto.stream.KickPlayerRsp", null, i), o.exportSymbol("proto.stream.KickTeamMemberNotify", null, i), o.exportSymbol("proto.stream.KickTeamMemberReq", null, i), o.exportSymbol("proto.stream.KickTeamMemberRsp", null, i), o.exportSymbol("proto.stream.LeaveRoomReq", null, i), o.exportSymbol("proto.stream.LeaveRoomRsp", null, i), o.exportSymbol("proto.stream.LeaveTeamNotify", null, i), o.exportSymbol("proto.stream.LeaveTeamReq", null, i), o.exportSymbol("proto.stream.LeaveTeamRsp", null, i), o.exportSymbol("proto.stream.LeaveWatchRoomNotify", null, i), o.exportSymbol("proto.stream.LeaveWatchRoomReq", null, i), o.exportSymbol("proto.stream.LeaveWatchRoomRsp", null, i), o.exportSymbol("proto.stream.LoginReq", null, i), o.exportSymbol("proto.stream.LoginRsp", null, i), o.exportSymbol("proto.stream.LogoutRsp", null, i), o.exportSymbol("proto.stream.NoticeJoin", null, i), o.exportSymbol("proto.stream.NoticeLeave", null, i), o.exportSymbol("proto.stream.NoticeRoomProperty", null, i), o.exportSymbol("proto.stream.NoticeTeamProperty", null, i), o.exportSymbol("proto.stream.NoticeTeamUserProfile", null, i), o.exportSymbol("proto.stream.PlayRoom", null, i), o.exportSymbol("proto.stream.PlayerInfo", null, i), o.exportSymbol("proto.stream.RoomDetail", null, i), o.exportSymbol("proto.stream.RoomFilter", null, i), o.exportSymbol("proto.stream.RoomInfo", null, i), o.exportSymbol("proto.stream.RoomInfoEx", null, i), o.exportSymbol("proto.stream.RoomListSort", null, i), o.exportSymbol("proto.stream.RoomNetworkStateNotify", null, i), o.exportSymbol("proto.stream.RoomOverNotify", null, i), o.exportSymbol("proto.stream.RoomState", null, i), o.exportSymbol("proto.stream.RoomType", null, i), o.exportSymbol("proto.stream.SendTeamEventNotify", null, i), o.exportSymbol("proto.stream.SendTeamEventReq", null, i), o.exportSymbol("proto.stream.SendTeamEventRsp", null, i), o.exportSymbol("proto.stream.SetReconnectTimeoutReq", null, i), o.exportSymbol("proto.stream.SetReconnectTimeoutRsp", null, i), o.exportSymbol("proto.stream.SetRoomPropertyReq", null, i), o.exportSymbol("proto.stream.SetRoomPropertyRsp", null, i), o.exportSymbol("proto.stream.SetTeamPropertyReq", null, i), o.exportSymbol("proto.stream.SetTeamPropertyRsp", null, i), o.exportSymbol("proto.stream.SetTeamReconnectTimeoutReq", null, i), o.exportSymbol("proto.stream.SetTeamReconnectTimeoutRsp", null, i), o.exportSymbol("proto.stream.SetTeamUserProfileReq", null, i), o.exportSymbol("proto.stream.SetTeamUserProfileRsp", null, i), o.exportSymbol("proto.stream.SortOrder", null, i), o.exportSymbol("proto.stream.SpeedReq", null, i), o.exportSymbol("proto.stream.SpeedRsp", null, i), o.exportSymbol("proto.stream.TcpProtoHeader", null, i), o.exportSymbol("proto.stream.TeamDetail", null, i), o.exportSymbol("proto.stream.TeamDstType", null, i), o.exportSymbol("proto.stream.TeamInfo", null, i), o.exportSymbol("proto.stream.TeamMatchCond", null, i), o.exportSymbol("proto.stream.TeamMatchReq", null, i), o.exportSymbol("proto.stream.TeamMatchResultNotify", null, i), o.exportSymbol("proto.stream.TeamMatchRsp", null, i),o.exportSymbol("proto.stream.TeamMatchStartNotify", null, i),o.exportSymbol("proto.stream.TeamMsgType", null, i),o.exportSymbol("proto.stream.TeamNetworkStateNotify", null, i),o.exportSymbol("proto.stream.TeamNetworkStateReq", null, i),o.exportSymbol("proto.stream.TeamNetworkStateRsp", null, i),o.exportSymbol("proto.stream.UserV2", null, i),o.exportSymbol("proto.stream.WatchInfo", null, i),o.exportSymbol("proto.stream.WatchRoom", null, i),o.exportSymbol("proto.stream.WatchSetting", null, i),o.exportSymbol("proto.stream.keyValue", null, i),proto.stream.SpeedReq = function (e) {
            ...
            var r = {
                ...
                sdkversion: s.Message.getFieldWithDefault(t, 3, ""),
                gameversion: s.Message.getFieldWithDefault(t, 4, ""),
                echodata: t.getEchodata_asB64()
            };
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.SpeedReq.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.SpeedReq;
            ...
            var r = void 0;
            0 !== (r = e.getGameid()) && t.writeUint32(1, r), 0 !== (r = e.getUserid()) && t.writeUint32(2, r), 0 < (r = e.getSdkversion()).length && t.writeString(3, r), 0 < (r = e.getGameversion()).length && t.writeString(4, r), 0 < (r = e.getEchodata_asU8()).length && t.writeBytes(5, r)
            ...
            return s.Message.bytesAsB64(this.getEchodata())
        },proto.stream.SpeedReq.prototype.getEchodata_asU8 = function () {
            return s.Message.bytesAsU8(this.getEchodata())
            ...
            s.Message.initialize(this, e, 0, -1, null, null)
        },o.inherits(proto.stream.SpeedRsp, s.Message),o.DEBUG && !COMPILED && (proto.stream.SpeedRsp.displayName = "proto.stream.SpeedRsp"),s.Message.GENERATE_TO_OBJECT && (proto.stream.SpeedRsp.prototype.toObject = function (e) {
            return proto.stream.SpeedRsp.toObject(e, this)
        }, proto.stream.SpeedRsp.toObject = function (e, t) {
            var r = {status: s.Message.getFieldWithDefault(t, 1, 0), echodata: t.getEchodata_asB64()};
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.SpeedRsp.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.SpeedRsp;
            ...
            var r = {
                ...
                teamid: s.Message.getFieldWithDefault(t, 4, "0")
            };
            return e && (r.$jspbMessageInstance = t), r
            ...
            var r = void 0;
            0 !== (r = e.getStatus()) && t.writeEnum(1, r), r = e.getRoomid(), 0 !== parseInt(r, 10) && t.writeUint64String(2, r), 0 !== (r = e.getSetid()) && t.writeUint32(3, r), r = e.getTeamid(), 0 !== parseInt(r, 10) && t.writeUint64String(4, r)
        ...
        },proto.stream.LoginRsp.prototype.getSetid = function () {
            return s.Message.getFieldWithDefault(this, 3, 0)
        },proto.stream.LoginRsp.prototype.setSetid = function (e) {
            s.Message.setProto3IntField(this, 3, e)
        },proto.stream.LoginRsp.prototype.getTeamid = function () {
            return s.Message.getFieldWithDefault(this, 4, "0")
        },proto.stream.LoginRsp.prototype.setTeamid = function (e) {
            ...
            var r = {gameid: s.Message.getFieldWithDefault(t, 1, 0), roomid: s.Message.getFieldWithDefault(t, 2, "0")};
            return e && (r.$jspbMessageInstance = t), r
            ...
            var r = {gameid: s.Message.getFieldWithDefault(t, 1, 0), gsexist: s.Message.getFieldWithDefault(t, 2, 0)};
            return e && (r.$jspbMessageInstance = t), r
            ...
            var r = {userid: s.Message.getFieldWithDefault(t, 1, 0), timeout: s.Message.getFieldWithDefault(t, 2, 0)};
            return e && (r.$jspbMessageInstance = t), r
            ...
            s.Message.setProto3EnumField(this, 1, e)
        },proto.stream.SetTeamReconnectTimeoutReq = function (e) {
            s.Message.initialize(this, e, 0, -1, null, null)
        },o.inherits(proto.stream.SetTeamReconnectTimeoutReq, s.Message),o.DEBUG && !COMPILED && (proto.stream.SetTeamReconnectTimeoutReq.displayName = "proto.stream.SetTeamReconnectTimeoutReq"),s.Message.GENERATE_TO_OBJECT && (proto.stream.SetTeamReconnectTimeoutReq.prototype.toObject = function (e) {
            return proto.stream.SetTeamReconnectTimeoutReq.toObject(e, this)
        }, proto.stream.SetTeamReconnectTimeoutReq.toObject = function (e, t) {
            var r = {userid: s.Message.getFieldWithDefault(t, 1, 0), timeout: s.Message.getFieldWithDefault(t, 2, 0)};
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.SetTeamReconnectTimeoutReq.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.SetTeamReconnectTimeoutReq;
            return proto.stream.SetTeamReconnectTimeoutReq.deserializeBinaryFromReader(r, t)
        },proto.stream.SetTeamReconnectTimeoutReq.deserializeBinaryFromReader = function (e, t) {
            for (; t.nextField() && !t.isEndGroup();) {
                switch (t.getFieldNumber()) {
                    case 1:
                        var r = t.readUint32();
            ...
            return e
        },proto.stream.SetTeamReconnectTimeoutReq.prototype.serializeBinary = function () {
            var e = new s.BinaryWriter;
            return proto.stream.SetTeamReconnectTimeoutReq.serializeBinaryToWriter(this, e), e.getResultBuffer()
        },proto.stream.SetTeamReconnectTimeoutReq.serializeBinaryToWriter = function (e, t) {
            var r = void 0;
            0 !== (r = e.getUserid()) && t.writeUint32(1, r), 0 !== (r = e.getTimeout()) && t.writeInt32(2, r)
        },proto.stream.SetTeamReconnectTimeoutReq.prototype.getUserid = function () {
            return s.Message.getFieldWithDefault(this, 1, 0)
        },proto.stream.SetTeamReconnectTimeoutReq.prototype.setUserid = function (e) {
            s.Message.setProto3IntField(this, 1, e)
        },proto.stream.SetTeamReconnectTimeoutReq.prototype.getTimeout = function () {
            return s.Message.getFieldWithDefault(this, 2, 0)
        },proto.stream.SetTeamReconnectTimeoutReq.prototype.setTimeout = function (e) {
            s.Message.setProto3IntField(this, 2, e)
        },proto.stream.SetTeamReconnectTimeoutRsp = function (e) {
            s.Message.initialize(this, e, 0, -1, null, null)
        },o.inherits(proto.stream.SetTeamReconnectTimeoutRsp, s.Message),o.DEBUG && !COMPILED && (proto.stream.SetTeamReconnectTimeoutRsp.displayName = "proto.stream.SetTeamReconnectTimeoutRsp"),s.Message.GENERATE_TO_OBJECT && (proto.stream.SetTeamReconnectTimeoutRsp.prototype.toObject = function (e) {
            return proto.stream.SetTeamReconnectTimeoutRsp.toObject(e, this)
        }, proto.stream.SetTeamReconnectTimeoutRsp.toObject = function (e, t) {
            var r = {status: s.Message.getFieldWithDefault(t, 1, 0)};
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.SetTeamReconnectTimeoutRsp.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.SetTeamReconnectTimeoutRsp;
            return proto.stream.SetTeamReconnectTimeoutRsp.deserializeBinaryFromReader(r, t)
        },proto.stream.SetTeamReconnectTimeoutRsp.deserializeBinaryFromReader = function (e, t) {
            for (; t.nextField() && !t.isEndGroup();) {
                switch (t.getFieldNumber()) {
                    case 1:
                        var r = t.readEnum();
            ...
            return e
        },proto.stream.SetTeamReconnectTimeoutRsp.prototype.serializeBinary = function () {
            var e = new s.BinaryWriter;
            return proto.stream.SetTeamReconnectTimeoutRsp.serializeBinaryToWriter(this, e), e.getResultBuffer()
        },proto.stream.SetTeamReconnectTimeoutRsp.serializeBinaryToWriter = function (e, t) {
            var r;
            0 !== (r = e.getStatus()) && t.writeEnum(1, r)
        },proto.stream.SetTeamReconnectTimeoutRsp.prototype.getStatus = function () {
            return s.Message.getFieldWithDefault(this, 1, 0)
        },proto.stream.SetTeamReconnectTimeoutRsp.prototype.setStatus = function (e) {
            s.Message.setProto3EnumField(this, 1, e)
            ...
            var r = {key: s.Message.getFieldWithDefault(t, 1, ""), value: s.Message.getFieldWithDefault(t, 2, "")};
            return e && (r.$jspbMessageInstance = t), r
            ...
            var r = void 0;
            0 !== (r = e.getUserid()) && t.writeUint32(1, r), 0 < (r = e.getUserprofile_asU8()).length && t.writeBytes(2, r), 0 !== (r = e.getState()) && t.writeUint32(3, r)
            ...
            s.Message.setProto3BytesField(this, 2, e)
        },proto.stream.PlayerInfo.prototype.getState = function () {
            return s.Message.getFieldWithDefault(this, 3, 0)
        },proto.stream.PlayerInfo.prototype.setState = function (e) {
            s.Message.setProto3IntField(this, 3, e)
            ...
            var r = {
                ...
                addr: s.Message.getFieldWithDefault(t, 3, ""),
            ...
            var r = void 0;
            0 < (r = e.getBookid()).length && t.writeString(1, r), 0 < (r = e.getBookkey()).length && t.writeString(2, r), 0 < (r = e.getAddr()).length && t.writeString(3, r), 0 < (r = e.getWssproxy()).length && t.writeString(4, r)
            ...
            s.Message.setProto3StringField(this, 2, e)
        },proto.stream.BookInfo.prototype.getAddr = function () {
            return s.Message.getFieldWithDefault(this, 3, "")
        },proto.stream.BookInfo.prototype.setAddr = function (e) {
            s.Message.setProto3StringField(this, 3, e)
            ...
            var r = {
                ...
                setid: s.Message.getFieldWithDefault(t, 10, 0)
            };
            return e && (r.$jspbMessageInstance = t), r
            ...
            var r = void 0;
            r = e.getRoomid(), 0 !== parseInt(r, 10) && t.writeUint64String(1, r), 0 < (r = e.getRoomname()).length && t.writeString(2, r), 0 !== (r = e.getMaxplayer()) && t.writeUint32(3, r), 0 !== (r = e.getMode()) && t.writeInt32(4, r), 0 !== (r = e.getCanwatch()) && t.writeInt32(5, r), 0 !== (r = e.getVisibility()) && t.writeInt32(6, r), 0 < (r = e.getRoomproperty_asU8()).length && t.writeBytes(7, r), 0 !== (r = e.getOwner()) && t.writeUint32(8, r), 0 !== (r = e.getState()) && t.writeEnum(9, r), 0 !== (r = e.getSetid()) && t.writeUint32(10, r)
        ...
        },proto.stream.RoomInfo.prototype.getSetid = function () {
            return s.Message.getFieldWithDefault(this, 10, 0)
        },proto.stream.RoomInfo.prototype.setSetid = function (e) {
            s.Message.setProto3IntField(this, 10, e)
            ...
            var r = {
                ...
                deviceId: s.Message.getFieldWithDefault(t, 6, "")
            };
            return e && (r.$jspbMessageInstance = t), r
            ...
            var r = void 0;
            0 !== (r = e.getUserId()) && t.writeUint32(1, r), 0 !== (r = e.getGameId()) && t.writeUint32(2, r), 0 !== (r = e.getVersionSdk()) && t.writeUint32(3, r), 0 !== (r = e.getConnectionId()) && t.writeUint64(4, r), 0 !== (r = e.getServiceId()) && t.writeUint32(5, r), 0 < (r = e.getDeviceId()).length && t.writeString(6, r)
        ...
        },proto.stream.RoomNetworkStateNotify = function (e) {
            s.Message.initialize(this, e, 0, -1, null, null)
        },o.inherits(proto.stream.RoomNetworkStateNotify, s.Message),o.DEBUG && !COMPILED && (proto.stream.RoomNetworkStateNotify.displayName = "proto.stream.RoomNetworkStateNotify"),s.Message.GENERATE_TO_OBJECT && (proto.stream.RoomNetworkStateNotify.prototype.toObject = function (e) {
            return proto.stream.RoomNetworkStateNotify.toObject(e, this)
        }, proto.stream.RoomNetworkStateNotify.toObject = function (e, t) {
            var r = {
                roomid: s.Message.getFieldWithDefault(t, 1, "0"),
                userid: s.Message.getFieldWithDefault(t, 2, 0),
                state: s.Message.getFieldWithDefault(t, 3, 0),
            ...
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.RoomNetworkStateNotify.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.RoomNetworkStateNotify;
            return proto.stream.RoomNetworkStateNotify.deserializeBinaryFromReader(r, t)
        },proto.stream.RoomNetworkStateNotify.deserializeBinaryFromReader = function (e, t) {
            for (; t.nextField() && !t.isEndGroup();) {
                switch (t.getFieldNumber()) {
                    case 1:
                        var r = t.readUint64String();
            ...
            return e
        },proto.stream.RoomNetworkStateNotify.prototype.serializeBinary = function () {
            var e = new s.BinaryWriter;
            return proto.stream.RoomNetworkStateNotify.serializeBinaryToWriter(this, e), e.getResultBuffer()
        },proto.stream.RoomNetworkStateNotify.serializeBinaryToWriter = function (e, t) {
            var r = void 0;
        ...
        },proto.stream.RoomNetworkStateNotify.prototype.getRoomid = function () {
            return s.Message.getFieldWithDefault(this, 1, "0")
        },proto.stream.RoomNetworkStateNotify.prototype.setRoomid = function (e) {
            s.Message.setProto3StringIntField(this, 1, e)
        },proto.stream.RoomNetworkStateNotify.prototype.getUserid = function () {
            return s.Message.getFieldWithDefault(this, 2, 0)
        },proto.stream.RoomNetworkStateNotify.prototype.setUserid = function (e) {
            s.Message.setProto3IntField(this, 2, e)
        },proto.stream.RoomNetworkStateNotify.prototype.getState = function () {
            return s.Message.getFieldWithDefault(this, 3, 0)
        },proto.stream.RoomNetworkStateNotify.prototype.setState = function (e) {
            s.Message.setProto3IntField(this, 3, e)
        },proto.stream.RoomNetworkStateNotify.prototype.getOwner = function () {
            return s.Message.getFieldWithDefault(this, 4, 0)
        },proto.stream.RoomNetworkStateNotify.prototype.setOwner = function (e) {
            s.Message.setProto3IntField(this, 4, e)
            ...
            var r = {
                ...
                getsystemroom: s.Message.getFieldWithDefault(t, 7, 0)
            };
            return e && (r.$jspbMessageInstance = t), r
            ...
            var r = void 0;
            0 !== (r = e.getMaxplayer()) && t.writeUint32(1, r), 0 !== (r = e.getMode()) && t.writeInt32(2, r), 0 !== (r = e.getCanwatch()) && t.writeInt32(3, r), 0 < (r = e.getRoomproperty_asU8()).length && t.writeBytes(4, r), 0 !== (r = e.getFull()) && t.writeInt32(5, r), 0 !== (r = e.getState()) && t.writeEnum(6, r), 0 !== (r = e.getGetsystemroom()) && t.writeInt32(7, r)
        ...
        },proto.stream.RoomFilter.prototype.setGetsystemroom = function (e) {
            ...
            var r, o = {
                ...
                setid: s.Message.getFieldWithDefault(t, 13, 0)
            };
            return e && (o.$jspbMessageInstance = t), o
            ...
            var r = void 0;
            r = e.getRoomid(), 0 !== parseInt(r, 10) && t.writeUint64String(1, r), 0 < (r = e.getRoomname()).length && t.writeString(2, r), 0 !== (r = e.getMaxplayer()) && t.writeUint32(3, r), 0 !== (r = e.getGameplayer()) && t.writeUint32(4, r), 0 !== (r = e.getWatchplayer()) && t.writeUint32(5, r), 0 !== (r = e.getMode()) && t.writeInt32(6, r), 0 !== (r = e.getCanwatch()) && t.writeInt32(7, r), 0 < (r = e.getRoomproperty_asU8()).length && t.writeBytes(8, r), 0 !== (r = e.getOwner()) && t.writeUint32(9, r), 0 !== (r = e.getState()) && t.writeEnum(10, r), r = e.getCreatetime(), 0 !== parseInt(r, 10) && t.writeUint64String(11, r), null != (r = e.getWatchinfo()) && t.writeMessage(12, r, proto.stream.WatchInfo.serializeBinaryToWriter), 0 !== (r = e.getSetid()) && t.writeUint32(13, r)
        ...
        },proto.stream.RoomInfoEx.prototype.getSetid = function () {
            return s.Message.getFieldWithDefault(this, 13, 0)
        },proto.stream.RoomInfoEx.prototype.setSetid = function (e) {
            s.Message.setProto3IntField(this, 13, e)
        ...
        proto.stream.GetRoomListExRsp.prototype.clearRoominfoexList = function () {
            ...
            var r, o = {
                ...
                setid: s.Message.getFieldWithDefault(t, 12, 0)
            };
            return e && (o.$jspbMessageInstance = t), o
        ...
        },proto.stream.RoomDetail.prototype.getSetid = function () {
            return s.Message.getFieldWithDefault(this, 12, 0)
        },proto.stream.RoomDetail.prototype.setSetid = function (e) {
            s.Message.setProto3IntField(this, 12, e)
            ...
            var r = {roomid: s.Message.getFieldWithDefault(t, 1, "0"), cpproto: t.getCpproto_asB64()};
            return e && (r.$jspbMessageInstance = t), r
            ...
            var r = {
                ...
                teamproperty: t.getTeamproperty_asB64()
            };
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.TeamInfo.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.TeamInfo;
            ...
            var r = void 0;
            r = e.getTeamid(), 0 !== parseInt(r, 10) && t.writeUint64String(1, r), 0 < (r = e.getPassword()).length && t.writeString(2, r), 0 !== (r = e.getCapacity()) && t.writeUint32(3, r), 0 !== (r = e.getMode()) && t.writeInt32(4, r), 0 !== (r = e.getVisibility()) && t.writeInt32(5, r), 0 !== (r = e.getOwner()) && t.writeUint32(6, r), 0 < (r = e.getTeamproperty_asU8()).length && t.writeBytes(7, r)
            ...
            s.Message.setProto3IntField(this, 6, e)
        },proto.stream.TeamInfo.prototype.getTeamproperty = function () {
            return s.Message.getFieldWithDefault(this, 7, "")
        },proto.stream.TeamInfo.prototype.getTeamproperty_asB64 = function () {
            return s.Message.bytesAsB64(this.getTeamproperty())
        },proto.stream.TeamInfo.prototype.getTeamproperty_asU8 = function () {
            return s.Message.bytesAsU8(this.getTeamproperty())
        },proto.stream.TeamInfo.prototype.setTeamproperty = function (e) {
            s.Message.setProto3BytesField(this, 7, e)
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.CreateTeamReq;
            ...
            var r = {
                ...
                owner: s.Message.getFieldWithDefault(t, 3, 0),
                setid: s.Message.getFieldWithDefault(t, 4, 0)
            };
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.CreateTeamRsp.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.CreateTeamRsp;
            ...
            var r = void 0;
            0 !== (r = e.getStatus()) && t.writeEnum(1, r), r = e.getTeamid(), 0 !== parseInt(r, 10) && t.writeUint64String(2, r), 0 !== (r = e.getOwner()) && t.writeUint32(3, r), 0 !== (r = e.getSetid()) && t.writeUint32(4, r)
            ...
            s.Message.setProto3IntField(this, 3, e)
        },proto.stream.CreateTeamRsp.prototype.getSetid = function () {
            return s.Message.getFieldWithDefault(this, 4, 0)
        },proto.stream.CreateTeamRsp.prototype.setSetid = function (e) {
            s.Message.setProto3IntField(this, 4, e)
            ...
            var r, o = {
                ...
                jointype: s.Message.getFieldWithDefault(t, 5, 0)
            };
            return e && (o.$jspbMessageInstance = t), o
        }),proto.stream.JoinTeamReq.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.JoinTeamReq;
            ...
            var r = void 0;
            0 !== (r = e.getGameid()) && t.writeUint32(1, r), r = e.getTeamid(), 0 !== parseInt(r, 10) && t.writeUint64String(2, r), null != (r = e.getPlayerinfo()) && t.writeMessage(3, r, proto.stream.PlayerInfo.serializeBinaryToWriter), 0 < (r = e.getPassword()).length && t.writeString(4, r), 0 !== (r = e.getJointype()) && t.writeEnum(5, r)
            ...
            s.Message.setProto3StringField(this, 4, e)
        },proto.stream.JoinTeamReq.prototype.getJointype = function () {
            return s.Message.getFieldWithDefault(this, 5, 0)
        },proto.stream.JoinTeamReq.prototype.setJointype = function (e) {
            ...
            var r, o = {
                ...
                teaminfo: (r = t.getTeaminfo()) && proto.stream.TeamInfo.toObject(e, r),
                usersList: s.Message.toObjectList(t.getUsersList(), proto.stream.PlayerInfo.toObject, e),
                ismatching: s.Message.getFieldWithDefault(t, 4, !1)
            };
            return e && (o.$jspbMessageInstance = t), o
        }),proto.stream.JoinTeamRsp.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.JoinTeamRsp;
            ...
            var r = void 0;
            0 !== (r = e.getStatus()) && t.writeEnum(1, r), null != (r = e.getTeaminfo()) && t.writeMessage(2, r, proto.stream.TeamInfo.serializeBinaryToWriter), 0 < (r = e.getUsersList()).length && t.writeRepeatedMessage(3, r, proto.stream.PlayerInfo.serializeBinaryToWriter), (r = e.getIsmatching()) && t.writeBool(4, r)
            ...
            this.setUsersList([])
        },proto.stream.JoinTeamRsp.prototype.getIsmatching = function () {
            return s.Message.getFieldWithDefault(this, 4, !1)
        },proto.stream.JoinTeamRsp.prototype.setIsmatching = function (e) {
            s.Message.setProto3BooleanField(this, 4, e)
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.JoinTeamNotify;
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.LeaveTeamReq;
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.LeaveTeamRsp;
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.LeaveTeamNotify;
            ...
            s.Message.initialize(this, e, 0, -1, proto.stream.TeamMatchCond.repeatedFields_, null)
        },o.inherits(proto.stream.TeamMatchCond, s.Message),o.DEBUG && !COMPILED && (proto.stream.TeamMatchCond.displayName = "proto.stream.TeamMatchCond"),proto.stream.TeamMatchCond.repeatedFields_ = [8],s.Message.GENERATE_TO_OBJECT && (proto.stream.TeamMatchCond.prototype.toObject = function (e) {
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.TeamMatchCond;
            ...
            var r = void 0;
            0 !== (r = e.getTeamnum()) && t.writeUint32(1, r), 0 !== (r = e.getTeammembernum()) && t.writeUint32(2, r), 0 !== (r = e.getTimeout()) && t.writeUint32(3, r), 0 !== (r = e.getWeight()) && t.writeUint32(4, r), 0 !== (r = e.getWeightrange()) && t.writeUint32(5, r), 0 !== (r = e.getWeightrule()) && t.writeUint32(6, r), 0 !== (r = e.getFull()) && t.writeUint32(7, r), 0 < (r = e.getTagsList()).length && t.writeRepeatedMessage(8, r, proto.stream.keyValue.serializeBinaryToWriter)
            ...
            s.Message.setProto3IntField(this, 7, e)
        },proto.stream.TeamMatchCond.prototype.getTagsList = function () {
            return s.Message.getRepeatedWrapperField(this, proto.stream.keyValue, 8)
        },proto.stream.TeamMatchCond.prototype.setTagsList = function (e) {
            s.Message.setRepeatedWrapperField(this, 8, e)
        },proto.stream.TeamMatchCond.prototype.addTags = function (e, t) {
            return s.Message.addToRepeatedWrapperField(this, 8, e, proto.stream.keyValue, t)
        },proto.stream.TeamMatchCond.prototype.clearTagsList = function () {
            this.setTagsList([])
            ...
            var r, o = {
                ...
                roominfo: (r = t.getRoominfo()) && proto.stream.RoomInfo.toObject(e, r),
                watchsetting: (r = t.getWatchsetting()) && proto.stream.WatchSetting.toObject(e, r),
                canceltype: s.Message.getFieldWithDefault(t, 7, 0)
            };
            return e && (o.$jspbMessageInstance = t), o
        }),proto.stream.TeamMatchReq.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.TeamMatchReq;
            ...
            var r = void 0;
            0 !== (r = e.getGameid()) && t.writeUint32(1, r), r = e.getTeamid(), 0 !== parseInt(r, 10) && t.writeUint64String(2, r), 0 !== (r = e.getUserid()) && t.writeUint32(3, r), null != (r = e.getCond()) && t.writeMessage(4, r, proto.stream.TeamMatchCond.serializeBinaryToWriter), null != (r = e.getRoominfo()) && t.writeMessage(5, r, proto.stream.RoomInfo.serializeBinaryToWriter), null != (r = e.getWatchsetting()) && t.writeMessage(6, r, proto.stream.WatchSetting.serializeBinaryToWriter), 0 !== (r = e.getCanceltype()) && t.writeUint32(7, r)
        ...
        },proto.stream.TeamMatchReq.prototype.getCanceltype = function () {
            return s.Message.getFieldWithDefault(this, 7, 0)
        },proto.stream.TeamMatchReq.prototype.setCanceltype = function (e) {
            s.Message.setProto3IntField(this, 7, e)
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.TeamMatchRsp;
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.TeamDetail;
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.BrigadeInfo;
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.TeamMatchResultNotify;
            ...
            var r = {teamid: s.Message.getFieldWithDefault(t, 1, "0"), userid: s.Message.getFieldWithDefault(t, 2, 0)};
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.TeamMatchStartNotify.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.TeamMatchStartNotify;
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.CancelTeamMatchReq;
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.CancelTeamMatchRsp;
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.CancelTeamMatchNotify;
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.SendTeamEventReq;
        ...
        proto.stream.SendTeamEventReq.prototype.setMsgtype = function (e) {
            ...
            var r = {status: s.Message.getFieldWithDefault(t, 1, 0), dstuseridsList: s.Message.getRepeatedField(t, 2)};
            return e && (r.$jspbMessageInstance = t), r
        }), proto.stream.SendTeamEventRsp.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.SendTeamEventRsp;
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.SendTeamEventNotify;
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.KickTeamMemberReq;
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.KickTeamMemberRsp;
            ...
            var t = new s.BinaryReader(e), r = new proto.stream.KickTeamMemberNotify;
            ...
            s.Message.setProto3BytesField(this, 6, e)
        },proto.stream.SetTeamPropertyReq = function (e) {
            s.Message.initialize(this, e, 0, -1, null, null)
        },o.inherits(proto.stream.SetTeamPropertyReq, s.Message),o.DEBUG && !COMPILED && (proto.stream.SetTeamPropertyReq.displayName = "proto.stream.SetTeamPropertyReq"),s.Message.GENERATE_TO_OBJECT && (proto.stream.SetTeamPropertyReq.prototype.toObject = function (e) {
            return proto.stream.SetTeamPropertyReq.toObject(e, this)
        }, proto.stream.SetTeamPropertyReq.toObject = function (e, t) {
            var r = {
                gameid: s.Message.getFieldWithDefault(t, 1, 0),
                teamid: s.Message.getFieldWithDefault(t, 2, "0"),
                userid: s.Message.getFieldWithDefault(t, 3, 0),
            ...
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.SetTeamPropertyReq.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.SetTeamPropertyReq;
            return proto.stream.SetTeamPropertyReq.deserializeBinaryFromReader(r, t)
        },proto.stream.SetTeamPropertyReq.deserializeBinaryFromReader = function (e, t) {
            for (; t.nextField() && !t.isEndGroup();) {
                switch (t.getFieldNumber()) {
                    case 1:
                        var r = t.readUint32();
            ...
            return e
        },proto.stream.SetTeamPropertyReq.prototype.serializeBinary = function () {
            var e = new s.BinaryWriter;
            return proto.stream.SetTeamPropertyReq.serializeBinaryToWriter(this, e), e.getResultBuffer()
        },proto.stream.SetTeamPropertyReq.serializeBinaryToWriter = function (e, t) {
            var r = void 0;
            0 !== (r = e.getGameid()) && t.writeUint32(1, r), r = e.getTeamid(), 0 !== parseInt(r, 10) && t.writeUint64String(2, r), 0 !== (r = e.getUserid()) && t.writeUint32(3, r), 0 < (r = e.getTeamproperty_asU8()).length && t.writeBytes(4, r)
        },proto.stream.SetTeamPropertyReq.prototype.getGameid = function () {
            return s.Message.getFieldWithDefault(this, 1, 0)
        },proto.stream.SetTeamPropertyReq.prototype.setGameid = function (e) {
            s.Message.setProto3IntField(this, 1, e)
        },proto.stream.SetTeamPropertyReq.prototype.getTeamid = function () {
            return s.Message.getFieldWithDefault(this, 2, "0")
        },proto.stream.SetTeamPropertyReq.prototype.setTeamid = function (e) {
            s.Message.setProto3StringIntField(this, 2, e)
        },proto.stream.SetTeamPropertyReq.prototype.getUserid = function () {
            return s.Message.getFieldWithDefault(this, 3, 0)
        },proto.stream.SetTeamPropertyReq.prototype.setUserid = function (e) {
            s.Message.setProto3IntField(this, 3, e)
        },proto.stream.SetTeamPropertyReq.prototype.getTeamproperty = function () {
            return s.Message.getFieldWithDefault(this, 4, "")
        },proto.stream.SetTeamPropertyReq.prototype.getTeamproperty_asB64 = function () {
            return s.Message.bytesAsB64(this.getTeamproperty())
        },proto.stream.SetTeamPropertyReq.prototype.getTeamproperty_asU8 = function () {
            return s.Message.bytesAsU8(this.getTeamproperty())
        },proto.stream.SetTeamPropertyReq.prototype.setTeamproperty = function (e) {
            s.Message.setProto3BytesField(this, 4, e)
        },proto.stream.SetTeamPropertyRsp = function (e) {
            s.Message.initialize(this, e, 0, -1, null, null)
        },o.inherits(proto.stream.SetTeamPropertyRsp, s.Message),o.DEBUG && !COMPILED && (proto.stream.SetTeamPropertyRsp.displayName = "proto.stream.SetTeamPropertyRsp"),s.Message.GENERATE_TO_OBJECT && (proto.stream.SetTeamPropertyRsp.prototype.toObject = function (e) {
            return proto.stream.SetTeamPropertyRsp.toObject(e, this)
        }, proto.stream.SetTeamPropertyRsp.toObject = function (e, t) {
            var r = {
                status: s.Message.getFieldWithDefault(t, 1, 0),
                teamid: s.Message.getFieldWithDefault(t, 2, "0"),
                userid: s.Message.getFieldWithDefault(t, 3, 0),
            ...
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.SetTeamPropertyRsp.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.SetTeamPropertyRsp;
            return proto.stream.SetTeamPropertyRsp.deserializeBinaryFromReader(r, t)
        },proto.stream.SetTeamPropertyRsp.deserializeBinaryFromReader = function (e, t) {
            for (; t.nextField() && !t.isEndGroup();) {
                switch (t.getFieldNumber()) {
                    case 1:
                        var r = t.readEnum();
            ...
            return e
        },proto.stream.SetTeamPropertyRsp.prototype.serializeBinary = function () {
            var e = new s.BinaryWriter;
            return proto.stream.SetTeamPropertyRsp.serializeBinaryToWriter(this, e), e.getResultBuffer()
        },proto.stream.SetTeamPropertyRsp.serializeBinaryToWriter = function (e, t) {
            var r = void 0;
            0 !== (r = e.getStatus()) && t.writeEnum(1, r), r = e.getTeamid(), 0 !== parseInt(r, 10) && t.writeUint64String(2, r), 0 !== (r = e.getUserid()) && t.writeUint32(3, r), 0 < (r = e.getTeamproperty_asU8()).length && t.writeBytes(4, r)
        },proto.stream.SetTeamPropertyRsp.prototype.getStatus = function () {
            return s.Message.getFieldWithDefault(this, 1, 0)
        },proto.stream.SetTeamPropertyRsp.prototype.setStatus = function (e) {
            s.Message.setProto3EnumField(this, 1, e)
        },proto.stream.SetTeamPropertyRsp.prototype.getTeamid = function () {
            return s.Message.getFieldWithDefault(this, 2, "0")
        },proto.stream.SetTeamPropertyRsp.prototype.setTeamid = function (e) {
            s.Message.setProto3StringIntField(this, 2, e)
        },proto.stream.SetTeamPropertyRsp.prototype.getUserid = function () {
            return s.Message.getFieldWithDefault(this, 3, 0)
        },proto.stream.SetTeamPropertyRsp.prototype.setUserid = function (e) {
            s.Message.setProto3IntField(this, 3, e)
        },proto.stream.SetTeamPropertyRsp.prototype.getTeamproperty = function () {
            return s.Message.getFieldWithDefault(this, 4, "")
        },proto.stream.SetTeamPropertyRsp.prototype.getTeamproperty_asB64 = function () {
            return s.Message.bytesAsB64(this.getTeamproperty())
        },proto.stream.SetTeamPropertyRsp.prototype.getTeamproperty_asU8 = function () {
            return s.Message.bytesAsU8(this.getTeamproperty())
        },proto.stream.SetTeamPropertyRsp.prototype.setTeamproperty = function (e) {
            s.Message.setProto3BytesField(this, 4, e)
        },proto.stream.NoticeTeamProperty = function (e) {
            s.Message.initialize(this, e, 0, -1, null, null)
        },o.inherits(proto.stream.NoticeTeamProperty, s.Message),o.DEBUG && !COMPILED && (proto.stream.NoticeTeamProperty.displayName = "proto.stream.NoticeTeamProperty"),s.Message.GENERATE_TO_OBJECT && (proto.stream.NoticeTeamProperty.prototype.toObject = function (e) {
            return proto.stream.NoticeTeamProperty.toObject(e, this)
        }, proto.stream.NoticeTeamProperty.toObject = function (e, t) {
            var r = {
                teamid: s.Message.getFieldWithDefault(t, 1, "0"),
                userid: s.Message.getFieldWithDefault(t, 2, 0),
                teamproperty: t.getTeamproperty_asB64()
            ...
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.NoticeTeamProperty.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.NoticeTeamProperty;
            return proto.stream.NoticeTeamProperty.deserializeBinaryFromReader(r, t)
        },proto.stream.NoticeTeamProperty.deserializeBinaryFromReader = function (e, t) {
            for (; t.nextField() && !t.isEndGroup();) {
                switch (t.getFieldNumber()) {
                    case 1:
                        var r = t.readUint64String();
            ...
            return e
        },proto.stream.NoticeTeamProperty.prototype.serializeBinary = function () {
            var e = new s.BinaryWriter;
            return proto.stream.NoticeTeamProperty.serializeBinaryToWriter(this, e), e.getResultBuffer()
        },proto.stream.NoticeTeamProperty.serializeBinaryToWriter = function (e, t) {
            var r = void 0;
            r = e.getTeamid(), 0 !== parseInt(r, 10) && t.writeUint64String(1, r), 0 !== (r = e.getUserid()) && t.writeUint32(2, r), 0 < (r = e.getTeamproperty_asU8()).length && t.writeBytes(3, r)
        },proto.stream.NoticeTeamProperty.prototype.getTeamid = function () {
            return s.Message.getFieldWithDefault(this, 1, "0")
        },proto.stream.NoticeTeamProperty.prototype.setTeamid = function (e) {
            s.Message.setProto3StringIntField(this, 1, e)
        },proto.stream.NoticeTeamProperty.prototype.getUserid = function () {
            return s.Message.getFieldWithDefault(this, 2, 0)
        },proto.stream.NoticeTeamProperty.prototype.setUserid = function (e) {
            s.Message.setProto3IntField(this, 2, e)
        },proto.stream.NoticeTeamProperty.prototype.getTeamproperty = function () {
            return s.Message.getFieldWithDefault(this, 3, "")
        },proto.stream.NoticeTeamProperty.prototype.getTeamproperty_asB64 = function () {
            return s.Message.bytesAsB64(this.getTeamproperty())
        },proto.stream.NoticeTeamProperty.prototype.getTeamproperty_asU8 = function () {
            return s.Message.bytesAsU8(this.getTeamproperty())
        },proto.stream.NoticeTeamProperty.prototype.setTeamproperty = function (e) {
            s.Message.setProto3BytesField(this, 3, e)
        },proto.stream.SetTeamUserProfileReq = function (e) {
            s.Message.initialize(this, e, 0, -1, null, null)
        },o.inherits(proto.stream.SetTeamUserProfileReq, s.Message),o.DEBUG && !COMPILED && (proto.stream.SetTeamUserProfileReq.displayName = "proto.stream.SetTeamUserProfileReq"),s.Message.GENERATE_TO_OBJECT && (proto.stream.SetTeamUserProfileReq.prototype.toObject = function (e) {
            return proto.stream.SetTeamUserProfileReq.toObject(e, this)
        }, proto.stream.SetTeamUserProfileReq.toObject = function (e, t) {
            var r = {
                gameid: s.Message.getFieldWithDefault(t, 1, 0),
                teamid: s.Message.getFieldWithDefault(t, 2, "0"),
                userid: s.Message.getFieldWithDefault(t, 3, 0),
            ...
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.SetTeamUserProfileReq.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.SetTeamUserProfileReq;
            return proto.stream.SetTeamUserProfileReq.deserializeBinaryFromReader(r, t)
        },proto.stream.SetTeamUserProfileReq.deserializeBinaryFromReader = function (e, t) {
            for (; t.nextField() && !t.isEndGroup();) {
                switch (t.getFieldNumber()) {
                    case 1:
                        var r = t.readUint32();
            ...
            return e
        },proto.stream.SetTeamUserProfileReq.prototype.serializeBinary = function () {
            var e = new s.BinaryWriter;
            return proto.stream.SetTeamUserProfileReq.serializeBinaryToWriter(this, e), e.getResultBuffer()
        },proto.stream.SetTeamUserProfileReq.serializeBinaryToWriter = function (e, t) {
            var r = void 0;
            0 !== (r = e.getGameid()) && t.writeUint32(1, r), r = e.getTeamid(), 0 !== parseInt(r, 10) && t.writeUint64String(2, r), 0 !== (r = e.getUserid()) && t.writeUint32(3, r), 0 < (r = e.getUserprofile_asU8()).length && t.writeBytes(4, r)
        },proto.stream.SetTeamUserProfileReq.prototype.getGameid = function () {
            return s.Message.getFieldWithDefault(this, 1, 0)
        },proto.stream.SetTeamUserProfileReq.prototype.setGameid = function (e) {
            s.Message.setProto3IntField(this, 1, e)
        },proto.stream.SetTeamUserProfileReq.prototype.getTeamid = function () {
            return s.Message.getFieldWithDefault(this, 2, "0")
        },proto.stream.SetTeamUserProfileReq.prototype.setTeamid = function (e) {
            s.Message.setProto3StringIntField(this, 2, e)
        },proto.stream.SetTeamUserProfileReq.prototype.getUserid = function () {
            return s.Message.getFieldWithDefault(this, 3, 0)
        },proto.stream.SetTeamUserProfileReq.prototype.setUserid = function (e) {
            s.Message.setProto3IntField(this, 3, e)
        },proto.stream.SetTeamUserProfileReq.prototype.getUserprofile = function () {
            return s.Message.getFieldWithDefault(this, 4, "")
        },proto.stream.SetTeamUserProfileReq.prototype.getUserprofile_asB64 = function () {
            return s.Message.bytesAsB64(this.getUserprofile())
        },proto.stream.SetTeamUserProfileReq.prototype.getUserprofile_asU8 = function () {
            return s.Message.bytesAsU8(this.getUserprofile())
        },proto.stream.SetTeamUserProfileReq.prototype.setUserprofile = function (e) {
            s.Message.setProto3BytesField(this, 4, e)
        },proto.stream.SetTeamUserProfileRsp = function (e) {
            s.Message.initialize(this, e, 0, -1, null, null)
        },o.inherits(proto.stream.SetTeamUserProfileRsp, s.Message),o.DEBUG && !COMPILED && (proto.stream.SetTeamUserProfileRsp.displayName = "proto.stream.SetTeamUserProfileRsp"),s.Message.GENERATE_TO_OBJECT && (proto.stream.SetTeamUserProfileRsp.prototype.toObject = function (e) {
            return proto.stream.SetTeamUserProfileRsp.toObject(e, this)
        }, proto.stream.SetTeamUserProfileRsp.toObject = function (e, t) {
            var r = {
                status: s.Message.getFieldWithDefault(t, 1, 0),
                teamid: s.Message.getFieldWithDefault(t, 2, "0"),
                userid: s.Message.getFieldWithDefault(t, 3, 0),
            ...
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.SetTeamUserProfileRsp.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.SetTeamUserProfileRsp;
            return proto.stream.SetTeamUserProfileRsp.deserializeBinaryFromReader(r, t)
        },proto.stream.SetTeamUserProfileRsp.deserializeBinaryFromReader = function (e, t) {
            for (; t.nextField() && !t.isEndGroup();) {
                switch (t.getFieldNumber()) {
                    case 1:
                        var r = t.readEnum();
            ...
            return e
        },proto.stream.SetTeamUserProfileRsp.prototype.serializeBinary = function () {
            var e = new s.BinaryWriter;
            return proto.stream.SetTeamUserProfileRsp.serializeBinaryToWriter(this, e), e.getResultBuffer()
        },proto.stream.SetTeamUserProfileRsp.serializeBinaryToWriter = function (e, t) {
            var r = void 0;
            0 !== (r = e.getStatus()) && t.writeEnum(1, r), r = e.getTeamid(), 0 !== parseInt(r, 10) && t.writeUint64String(2, r), 0 !== (r = e.getUserid()) && t.writeUint32(3, r), 0 < (r = e.getUserprofile_asU8()).length && t.writeBytes(4, r)
        },proto.stream.SetTeamUserProfileRsp.prototype.getStatus = function () {
            return s.Message.getFieldWithDefault(this, 1, 0)
        },proto.stream.SetTeamUserProfileRsp.prototype.setStatus = function (e) {
            s.Message.setProto3EnumField(this, 1, e)
        },proto.stream.SetTeamUserProfileRsp.prototype.getTeamid = function () {
            return s.Message.getFieldWithDefault(this, 2, "0")
        },proto.stream.SetTeamUserProfileRsp.prototype.setTeamid = function (e) {
            s.Message.setProto3StringIntField(this, 2, e)
        },proto.stream.SetTeamUserProfileRsp.prototype.getUserid = function () {
            return s.Message.getFieldWithDefault(this, 3, 0)
        },proto.stream.SetTeamUserProfileRsp.prototype.setUserid = function (e) {
            s.Message.setProto3IntField(this, 3, e)
        },proto.stream.SetTeamUserProfileRsp.prototype.getUserprofile = function () {
            return s.Message.getFieldWithDefault(this, 4, "")
        },proto.stream.SetTeamUserProfileRsp.prototype.getUserprofile_asB64 = function () {
            return s.Message.bytesAsB64(this.getUserprofile())
        },proto.stream.SetTeamUserProfileRsp.prototype.getUserprofile_asU8 = function () {
            return s.Message.bytesAsU8(this.getUserprofile())
        },proto.stream.SetTeamUserProfileRsp.prototype.setUserprofile = function (e) {
            s.Message.setProto3BytesField(this, 4, e)
        },proto.stream.NoticeTeamUserProfile = function (e) {
            s.Message.initialize(this, e, 0, -1, null, null)
        },o.inherits(proto.stream.NoticeTeamUserProfile, s.Message),o.DEBUG && !COMPILED && (proto.stream.NoticeTeamUserProfile.displayName = "proto.stream.NoticeTeamUserProfile"),s.Message.GENERATE_TO_OBJECT && (proto.stream.NoticeTeamUserProfile.prototype.toObject = function (e) {
            return proto.stream.NoticeTeamUserProfile.toObject(e, this)
        }, proto.stream.NoticeTeamUserProfile.toObject = function (e, t) {
            var r = {
                teamid: s.Message.getFieldWithDefault(t, 1, "0"),
                userid: s.Message.getFieldWithDefault(t, 2, 0),
                userprofile: t.getUserprofile_asB64()
            ...
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.NoticeTeamUserProfile.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.NoticeTeamUserProfile;
            return proto.stream.NoticeTeamUserProfile.deserializeBinaryFromReader(r, t)
        },proto.stream.NoticeTeamUserProfile.deserializeBinaryFromReader = function (e, t) {
            for (; t.nextField() && !t.isEndGroup();) {
                switch (t.getFieldNumber()) {
                    case 1:
                        var r = t.readUint64String();
            ...
            return e
        },proto.stream.NoticeTeamUserProfile.prototype.serializeBinary = function () {
            var e = new s.BinaryWriter;
            return proto.stream.NoticeTeamUserProfile.serializeBinaryToWriter(this, e), e.getResultBuffer()
        },proto.stream.NoticeTeamUserProfile.serializeBinaryToWriter = function (e, t) {
            var r = void 0;
            r = e.getTeamid(), 0 !== parseInt(r, 10) && t.writeUint64String(1, r), 0 !== (r = e.getUserid()) && t.writeUint32(2, r), 0 < (r = e.getUserprofile_asU8()).length && t.writeBytes(3, r)
        },proto.stream.NoticeTeamUserProfile.prototype.getTeamid = function () {
            return s.Message.getFieldWithDefault(this, 1, "0")
        },proto.stream.NoticeTeamUserProfile.prototype.setTeamid = function (e) {
            s.Message.setProto3StringIntField(this, 1, e)
        },proto.stream.NoticeTeamUserProfile.prototype.getUserid = function () {
            return s.Message.getFieldWithDefault(this, 2, 0)
        },proto.stream.NoticeTeamUserProfile.prototype.setUserid = function (e) {
            s.Message.setProto3IntField(this, 2, e)
        },proto.stream.NoticeTeamUserProfile.prototype.getUserprofile = function () {
            return s.Message.getFieldWithDefault(this, 3, "")
        },proto.stream.NoticeTeamUserProfile.prototype.getUserprofile_asB64 = function () {
            return s.Message.bytesAsB64(this.getUserprofile())
        },proto.stream.NoticeTeamUserProfile.prototype.getUserprofile_asU8 = function () {
            return s.Message.bytesAsU8(this.getUserprofile())
        },proto.stream.NoticeTeamUserProfile.prototype.setUserprofile = function (e) {
            s.Message.setProto3BytesField(this, 3, e)
        },proto.stream.TeamNetworkStateReq = function (e) {
            s.Message.initialize(this, e, 0, -1, null, null)
        },o.inherits(proto.stream.TeamNetworkStateReq, s.Message),o.DEBUG && !COMPILED && (proto.stream.TeamNetworkStateReq.displayName = "proto.stream.TeamNetworkStateReq"),s.Message.GENERATE_TO_OBJECT && (proto.stream.TeamNetworkStateReq.prototype.toObject = function (e) {
            return proto.stream.TeamNetworkStateReq.toObject(e, this)
        }, proto.stream.TeamNetworkStateReq.toObject = function (e, t) {
            var r = {
                gameid: s.Message.getFieldWithDefault(t, 1, 0),
                teamid: s.Message.getFieldWithDefault(t, 2, "0"),
                userid: s.Message.getFieldWithDefault(t, 3, 0),
            ...
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.TeamNetworkStateReq.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.TeamNetworkStateReq;
            return proto.stream.TeamNetworkStateReq.deserializeBinaryFromReader(r, t)
        },proto.stream.TeamNetworkStateReq.deserializeBinaryFromReader = function (e, t) {
            for (; t.nextField() && !t.isEndGroup();) {
                switch (t.getFieldNumber()) {
                    case 1:
                        var r = t.readUint32();
            ...
            return e
        },proto.stream.TeamNetworkStateReq.prototype.serializeBinary = function () {
            var e = new s.BinaryWriter;
            return proto.stream.TeamNetworkStateReq.serializeBinaryToWriter(this, e), e.getResultBuffer()
        },proto.stream.TeamNetworkStateReq.serializeBinaryToWriter = function (e, t) {
            var r = void 0;
            0 !== (r = e.getGameid()) && t.writeUint32(1, r), r = e.getTeamid(), 0 !== parseInt(r, 10) && t.writeUint64String(2, r), 0 !== (r = e.getUserid()) && t.writeUint32(3, r), 0 !== (r = e.getState()) && t.writeUint32(4, r)
        },proto.stream.TeamNetworkStateReq.prototype.getGameid = function () {
            return s.Message.getFieldWithDefault(this, 1, 0)
        },proto.stream.TeamNetworkStateReq.prototype.setGameid = function (e) {
            s.Message.setProto3IntField(this, 1, e)
        },proto.stream.TeamNetworkStateReq.prototype.getTeamid = function () {
            return s.Message.getFieldWithDefault(this, 2, "0")
        },proto.stream.TeamNetworkStateReq.prototype.setTeamid = function (e) {
            s.Message.setProto3StringIntField(this, 2, e)
        },proto.stream.TeamNetworkStateReq.prototype.getUserid = function () {
            return s.Message.getFieldWithDefault(this, 3, 0)
        },proto.stream.TeamNetworkStateReq.prototype.setUserid = function (e) {
            s.Message.setProto3IntField(this, 3, e)
        },proto.stream.TeamNetworkStateReq.prototype.getState = function () {
            return s.Message.getFieldWithDefault(this, 4, 0)
        },proto.stream.TeamNetworkStateReq.prototype.setState = function (e) {
            s.Message.setProto3IntField(this, 4, e)
        },proto.stream.TeamNetworkStateRsp = function (e) {
            s.Message.initialize(this, e, 0, -1, null, null)
        },o.inherits(proto.stream.TeamNetworkStateRsp, s.Message),o.DEBUG && !COMPILED && (proto.stream.TeamNetworkStateRsp.displayName = "proto.stream.TeamNetworkStateRsp"),s.Message.GENERATE_TO_OBJECT && (proto.stream.TeamNetworkStateRsp.prototype.toObject = function (e) {
            return proto.stream.TeamNetworkStateRsp.toObject(e, this)
        }, proto.stream.TeamNetworkStateRsp.toObject = function (e, t) {
            var r = {status: s.Message.getFieldWithDefault(t, 1, 0)};
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.TeamNetworkStateRsp.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.TeamNetworkStateRsp;
            return proto.stream.TeamNetworkStateRsp.deserializeBinaryFromReader(r, t)
        },proto.stream.TeamNetworkStateRsp.deserializeBinaryFromReader = function (e, t) {
            for (; t.nextField() && !t.isEndGroup();) {
                switch (t.getFieldNumber()) {
                    case 1:
                        var r = t.readEnum();
            ...
            return e
        },proto.stream.TeamNetworkStateRsp.prototype.serializeBinary = function () {
            var e = new s.BinaryWriter;
            return proto.stream.TeamNetworkStateRsp.serializeBinaryToWriter(this, e), e.getResultBuffer()
        },proto.stream.TeamNetworkStateRsp.serializeBinaryToWriter = function (e, t) {
            var r;
            0 !== (r = e.getStatus()) && t.writeEnum(1, r)
        },proto.stream.TeamNetworkStateRsp.prototype.getStatus = function () {
            return s.Message.getFieldWithDefault(this, 1, 0)
        },proto.stream.TeamNetworkStateRsp.prototype.setStatus = function (e) {
            s.Message.setProto3EnumField(this, 1, e)
        },proto.stream.TeamNetworkStateNotify = function (e) {
            s.Message.initialize(this, e, 0, -1, null, null)
        },o.inherits(proto.stream.TeamNetworkStateNotify, s.Message),o.DEBUG && !COMPILED && (proto.stream.TeamNetworkStateNotify.displayName = "proto.stream.TeamNetworkStateNotify"),s.Message.GENERATE_TO_OBJECT && (proto.stream.TeamNetworkStateNotify.prototype.toObject = function (e) {
            return proto.stream.TeamNetworkStateNotify.toObject(e, this)
        }, proto.stream.TeamNetworkStateNotify.toObject = function (e, t) {
            var r = {
                teamid: s.Message.getFieldWithDefault(t, 1, "0"),
                userid: s.Message.getFieldWithDefault(t, 2, 0),
                state: s.Message.getFieldWithDefault(t, 3, 0),
            ...
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.TeamNetworkStateNotify.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.TeamNetworkStateNotify;
            return proto.stream.TeamNetworkStateNotify.deserializeBinaryFromReader(r, t)
        },proto.stream.TeamNetworkStateNotify.deserializeBinaryFromReader = function (e, t) {
            for (; t.nextField() && !t.isEndGroup();) {
                switch (t.getFieldNumber()) {
                    case 1:
                        var r = t.readUint64String();
            ...
            return e
        },proto.stream.TeamNetworkStateNotify.prototype.serializeBinary = function () {
            var e = new s.BinaryWriter;
            return proto.stream.TeamNetworkStateNotify.serializeBinaryToWriter(this, e), e.getResultBuffer()
        },proto.stream.TeamNetworkStateNotify.serializeBinaryToWriter = function (e, t) {
            var r = void 0;
            r = e.getTeamid(), 0 !== parseInt(r, 10) && t.writeUint64String(1, r), 0 !== (r = e.getUserid()) && t.writeUint32(2, r), 0 !== (r = e.getState()) && t.writeUint32(3, r), 0 !== (r = e.getOwner()) && t.writeUint32(4, r)
        },proto.stream.TeamNetworkStateNotify.prototype.getTeamid = function () {
            return s.Message.getFieldWithDefault(this, 1, "0")
        },proto.stream.TeamNetworkStateNotify.prototype.setTeamid = function (e) {
            s.Message.setProto3StringIntField(this, 1, e)
        },proto.stream.TeamNetworkStateNotify.prototype.getUserid = function () {
            return s.Message.getFieldWithDefault(this, 2, 0)
        },proto.stream.TeamNetworkStateNotify.prototype.setUserid = function (e) {
            s.Message.setProto3IntField(this, 2, e)
        },proto.stream.TeamNetworkStateNotify.prototype.getState = function () {
            return s.Message.getFieldWithDefault(this, 3, 0)
        },proto.stream.TeamNetworkStateNotify.prototype.setState = function (e) {
            s.Message.setProto3IntField(this, 3, e)
        },proto.stream.TeamNetworkStateNotify.prototype.getOwner = function () {
            return s.Message.getFieldWithDefault(this, 4, 0)
        },proto.stream.TeamNetworkStateNotify.prototype.setOwner = function (e) {
            s.Message.setProto3IntField(this, 4, e)
        },proto.stream.GetTeamDetailReq = function (e) {
            s.Message.initialize(this, e, 0, -1, null, null)
        },o.inherits(proto.stream.GetTeamDetailReq, s.Message),o.DEBUG && !COMPILED && (proto.stream.GetTeamDetailReq.displayName = "proto.stream.GetTeamDetailReq"),s.Message.GENERATE_TO_OBJECT && (proto.stream.GetTeamDetailReq.prototype.toObject = function (e) {
            return proto.stream.GetTeamDetailReq.toObject(e, this)
        }, proto.stream.GetTeamDetailReq.toObject = function (e, t) {
            var r = {
                gameid: s.Message.getFieldWithDefault(t, 1, 0),
                teamid: s.Message.getFieldWithDefault(t, 2, "0"),
                userid: s.Message.getFieldWithDefault(t, 3, 0)
            ...
            return e && (r.$jspbMessageInstance = t), r
        }),proto.stream.GetTeamDetailReq.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.GetTeamDetailReq;
            return proto.stream.GetTeamDetailReq.deserializeBinaryFromReader(r, t)
        },proto.stream.GetTeamDetailReq.deserializeBinaryFromReader = function (e, t) {
            for (; t.nextField() && !t.isEndGroup();) {
                switch (t.getFieldNumber()) {
                    case 1:
                        var r = t.readUint32();
            ...
            return e
        },proto.stream.GetTeamDetailReq.prototype.serializeBinary = function () {
            var e = new s.BinaryWriter;
            return proto.stream.GetTeamDetailReq.serializeBinaryToWriter(this, e), e.getResultBuffer()
        },proto.stream.GetTeamDetailReq.serializeBinaryToWriter = function (e, t) {
            var r = void 0;
            0 !== (r = e.getGameid()) && t.writeUint32(1, r), r = e.getTeamid(), 0 !== parseInt(r, 10) && t.writeUint64String(2, r), 0 !== (r = e.getUserid()) && t.writeUint32(3, r)
        },proto.stream.GetTeamDetailReq.prototype.getGameid = function () {
            return s.Message.getFieldWithDefault(this, 1, 0)
        },proto.stream.GetTeamDetailReq.prototype.setGameid = function (e) {
            s.Message.setProto3IntField(this, 1, e)
        },proto.stream.GetTeamDetailReq.prototype.getTeamid = function () {
            return s.Message.getFieldWithDefault(this, 2, "0")
        },proto.stream.GetTeamDetailReq.prototype.setTeamid = function (e) {
            s.Message.setProto3StringIntField(this, 2, e)
        },proto.stream.GetTeamDetailReq.prototype.getUserid = function () {
            return s.Message.getFieldWithDefault(this, 3, 0)
        },proto.stream.GetTeamDetailReq.prototype.setUserid = function (e) {
            s.Message.setProto3IntField(this, 3, e)
        },proto.stream.GetTeamDetailRsp = function (e) {
            s.Message.initialize(this, e, 0, -1, proto.stream.GetTeamDetailRsp.repeatedFields_, null)
        },o.inherits(proto.stream.GetTeamDetailRsp, s.Message),o.DEBUG && !COMPILED && (proto.stream.GetTeamDetailRsp.displayName = "proto.stream.GetTeamDetailRsp"),proto.stream.GetTeamDetailRsp.repeatedFields_ = [3],s.Message.GENERATE_TO_OBJECT && (proto.stream.GetTeamDetailRsp.prototype.toObject = function (e) {
            return proto.stream.GetTeamDetailRsp.toObject(e, this)
        }, proto.stream.GetTeamDetailRsp.toObject = function (e, t) {
            var r, o = {
                status: s.Message.getFieldWithDefault(t, 1, 0),
                teaminfo: (r = t.getTeaminfo()) && proto.stream.TeamInfo.toObject(e, r),
                usersList: s.Message.toObjectList(t.getUsersList(), proto.stream.PlayerInfo.toObject, e),
            ...
            return e && (o.$jspbMessageInstance = t), o
        }),proto.stream.GetTeamDetailRsp.deserializeBinary = function (e) {
            var t = new s.BinaryReader(e), r = new proto.stream.GetTeamDetailRsp;
            return proto.stream.GetTeamDetailRsp.deserializeBinaryFromReader(r, t)
        },proto.stream.GetTeamDetailRsp.deserializeBinaryFromReader = function (e, t) {
            for (; t.nextField() && !t.isEndGroup();) {
                switch (t.getFieldNumber()) {
                    case 1:
                        var r = t.readEnum();
            ...
            return e
        },proto.stream.GetTeamDetailRsp.prototype.serializeBinary = function () {
            var e = new s.BinaryWriter;
            return proto.stream.GetTeamDetailRsp.serializeBinaryToWriter(this, e), e.getResultBuffer()
        },proto.stream.GetTeamDetailRsp.serializeBinaryToWriter = function (e, t) {
            var r = void 0;
            0 !== (r = e.getStatus()) && t.writeEnum(1, r), null != (r = e.getTeaminfo()) && t.writeMessage(2, r, proto.stream.TeamInfo.serializeBinaryToWriter), 0 < (r = e.getUsersList()).length && t.writeRepeatedMessage(3, r, proto.stream.PlayerInfo.serializeBinaryToWriter), (r = e.getIsmatching()) && t.writeBool(4, r)
        },proto.stream.GetTeamDetailRsp.prototype.getStatus = function () {
            return s.Message.getFieldWithDefault(this, 1, 0)
        },proto.stream.GetTeamDetailRsp.prototype.setStatus = function (e) {
            s.Message.setProto3EnumField(this, 1, e)
        },proto.stream.GetTeamDetailRsp.prototype.getTeaminfo = function () {
            return s.Message.getWrapperField(this, proto.stream.TeamInfo, 2)
        },proto.stream.GetTeamDetailRsp.prototype.setTeaminfo = function (e) {
            s.Message.setWrapperField(this, 2, e)
        },proto.stream.GetTeamDetailRsp.prototype.clearTeaminfo = function () {
            this.setTeaminfo(void 0)
        },proto.stream.GetTeamDetailRsp.prototype.hasTeaminfo = function () {
            return null != s.Message.getField(this, 2)
        },proto.stream.GetTeamDetailRsp.prototype.getUsersList = function () {
            return s.Message.getRepeatedWrapperField(this, proto.stream.PlayerInfo, 3)
        },proto.stream.GetTeamDetailRsp.prototype.setUsersList = function (e) {
            s.Message.setRepeatedWrapperField(this, 3, e)
        },proto.stream.GetTeamDetailRsp.prototype.addUsers = function (e, t) {
            return s.Message.addToRepeatedWrapperField(this, 3, e, proto.stream.PlayerInfo, t)
        },proto.stream.GetTeamDetailRsp.prototype.clearUsersList = function () {
            this.setUsersList([])
        },proto.stream.GetTeamDetailRsp.prototype.getIsmatching = function () {
            return s.Message.getFieldWithDefault(this, 4, !1)
        },proto.stream.GetTeamDetailRsp.prototype.setIsmatching = function (e) {
            s.Message.setProto3BooleanField(this, 4, e)
        },proto.stream.CmdId = {
            NOCMD: 0,
            SPEEDREQ: 1001,
            ...
            SETTEAMRECONNECTTIMEOUTREQ: 1111,
            SETTEAMRECONNECTTIMEOUTRSP: 1112,
            NOTICEROOMNETWORKSTATE: 1122,
            NOTICETEAMNETWORKSTATE: 1123,
            JOINROOMREQ: 1201,
            JOINROOMRSP: 1202,
            ...
            SETTEAMPROPERTYREQ: 1247,
            SETTEAMPROPERTYRSP: 1248,
            NOTICETEAMPROPERTY: 1316,
            SETTEAMUSERPROFILEREQ: 1249,
            SETTEAMUSERPROFILERSP: 1250,
            NOTICETEAMUSERPROFILE: 1317,
            GETTEAMDETAILREQ: 1153,
            GETTEAMDETAILRSP: 1154
            ...
            ROOMSORTPLAYERNUM: 2,
            ROOMSORTSTATE: 3
        },proto.stream.SortOrder = {SORTASC: 0, SORTDESC: 1},proto.stream.RoomType = {
            GAMEROOMTYPE: 0,
            WATCHROOMTYPE: 1
        },proto.stream.JoinTeamType = {
            JOINSPECIALTEAM: 0,
            REJOINTEAM: 1
    ...
    }, {"./errorcode_pb.js": 3, "google-protobuf": 1}],
    6: [function (e, t, r) {
        var o = e("google-protobuf"), s = o, i = window;
    ...
    7: [function (e, t, r) {
        ...
        o.exportSymbol("proto.stream.EnterLiveRoom", null, i), o.exportSymbol("proto.stream.EnterLiveRoomAck", null, i), o.exportSymbol("proto.stream.EnterLiveRoomNotify", null, i), o.exportSymbol("proto.stream.ExitLiveRoomNotify", null, i), o.exportSymbol("proto.stream.LiveBroadcast", null, i), o.exportSymbol("proto.stream.LiveBroadcastAck", null, i), o.exportSymbol("proto.stream.LiveBroadcastNotify", null, i), o.exportSymbol("proto.stream.LiveFrameDataNotify", null, i), o.exportSymbol("proto.stream.LiveFrameSyncNotify", null, i), o.exportSymbol("proto.stream.LiveHeartbeat", null, i), o.exportSymbol("proto.stream.LiveHeartbeatAck", null, i), o.exportSymbol("proto.stream.LiveOverNotify", null, i), o.exportSymbol("proto.stream.SDKWatchCmdID", null, i), o.exportSymbol("proto.stream.SetLiveOffset", null, i), o.exportSymbol("proto.stream.SetLiveOffsetAck", null, i), proto.stream.EnterLiveRoom = function (e) {
            ...
            var r = {userid: s.Message.getFieldWithDefault(t, 1, 0), userprofile: t.getUserprofile_asB64()};
            return e && (r.$jspbMessageInstance = t), r
    ...
    }, {"./common_pb.js": 2, "google-protobuf": 1}]
}, {}, [4]), function (e) {
    ...
    }, e.MsCreateTeamInfo = function (e, t, r, o, s, i) {
        this.password = e, this.capacity = t, this.mode = r, this.visibility = o, this.userProfile = s, this.teamProperty = i
    }, e.MsTeamMatchCond = function (e, t, r, o, s, i, a, n) {
        this.teamNum = e, this.teamMemberNum = t, this.timeout = r, this.weight = o, this.weightRange = s, this.weightRule = i, this.full = a, this.tags = n
...
var MvsCode = {NoLogin: -2, CODE_201: 201, CODE_1000: 1e3, NetworkErr: 1001, CODE_1005: 1005, DataParseErr: 1606},
    MvsErrMsg = new function () {
        this[1001] = "network error, please reference [ https://doc.matchvs.com/APIDoc/erroCode ]", this[1e3] = "netwrk closed normal ", this[1005] = "netwrk closed no status ", this[1606] = "you data parse error ", this[400] = "bad request ", this[401] = "invaild appkey ", this[402] = "invaild sign [ https://doc.matchvs.com/APIDoc/erroCode ]", this[403] = "forbidden", this[404] = "not found anything, please reference [ https://doc.matchvs.com/APIDoc/erroCode ]", this[405] = "room have full, please reference [ https://doc.matchvs.com/APIDoc/erroCode ]", this[406] = "room had joinOver, please reference [ https://doc.matchvs.com/APIDoc/erroCode ]", this[500] = "server error, please reference [ https://doc.matchvs.com/APIDoc/erroCode ]", this[502] = "service stoped,the license expires or the account is in arrears. please reference [ https://doc.matchvs.com/PaymentHelp ]", this[503] = "the ccu exceed the limit. please reference [ https://doc.matchvs.com/PaymentHelp ]", this[504] = "your traffic is running out today,please recharge [ https://doc.matchvs.com/PaymentHelp ]", this[507] = "room does not exist", this[509] = "not in the room ", this[521] = "gameServer not exist, please check your gameserver is ok [ https://doc.matchvs.com/QuickStart/gsQuickStart ]", this[522] = "frame sync is close, please call the api 'setFrameSync' [ https://doc.matchvs.com/APIDoc/erroCode ]", this[523] = "gameServer internal error, need check you game server [ https://doc.matchvs.com/APIDoc/erroCode ] ", this[527] = "sending message too often ,  can't exceed 500 times per second [ https://doc.matchvs.com/APIDoc/erroCode ]", this[201] = "reconnect not in room [ https://doc.matchvs.com/APIDoc/erroCode ]", this[422] = "team match timeout", this[423] = "parameters is incorrect"
    };
...
function MsRoomJoin(e, t, r, o, s, i, a, n, p, g, m) {
    this.joinType = e, this.userID = t, this.roomID = r, this.gameID = o, this.maxPlayer = s, this.mode = i, this.canWatch = a, this.tags = p, this.userProfile = n, this.visibility = g, this.roomProperty = m, MatchvsLog.logI(this + " MsRoomJoin:" + JSON.stringify(this))
}
...
function MsLoginRsp(e, t, r) {
    this.status = e, this.roomID = t, this.teamID = r, MatchvsLog.logI("MsLoginRsp::" + JSON.stringify(this))
}
...
function MsRoomFilterEx(e, t, r, o, s, i, a, n, p, g, m) {
    this.maxPlayer = e, this.mode = t, this.canWatch = r, this.roomProperty = o, this.full = s, this.state = i, this.sort = a, this.order = n, this.pageNo = p, this.pageSize = g || 10, this.getSystemRoom = m, MatchvsLog.logI(this + " MsRoomFilterEx:" + JSON.stringify(this))
}

function MsGetRoomDetailRsp(e, t, r, o, s, i, a, n, p, g, m) {
    this.status = e, this.state = t, this.maxPlayer = r, this.mode = o, this.canWatch = s, this.roomProperty = i, this.owner = a, this.createFlag = n, this.userInfos = [], this.userInfos = p, this.watchinfo = g, this.brigades = m, MatchvsLog.logI(this + " MsGetRoomDetailRsp:" + JSON.stringify(this))
}

function MsRoomAttribute(e, t, r, o, s, i, a, n, p, g, m, l) {
    this.roomID = e, this.roomName = t, this.maxPlayer = r, this.gamePlayer = o, this.watchPlayer = s, this.mode = i, this.canWatch = a, this.roomProperty = n, this.owner = p, this.state = g, this.createTime = m, this.watchSet = l, MatchvsLog.logI(this + " MsRoomAttribute:" + JSON.stringify(this))
}
...
MsEnum.JoinRoomType = {
    ...
    try {
        e.MatchvsNetWork = function (e, t) {
            ...
            var s = null, i = !1, a = [], n = t, r = e, o = !1, p = this;
            this.close = function () {
                s && (o = !0, s.close())
            }, this.send = function (e) {
                if (i) {
            ...
            var g = function (e) {
                for (o = !1, MatchvsLog.logI("[egret.WebSocket][connect]:" + e), i = !0; 0 < a.length;) p.send(a.pop());
                n.onConnect && n.onConnect(r)
            }, m = function (e) {
                e = o ? {code: 1e3} : {code: 1001}, i = !1, n.onDisConnect && n.onDisConnect(r, e), MatchvsLog.logI("[egret.WebSocket] [onClose] case:" + e)
            }, l = function () {
                ...
                n.onDisConnect && n.onDisConnect(r, e = {code: "1006"}), MatchvsLog.logI("[egret.WebSocket] [onError] case:" + e)
            };
            !function () {
                (s = new egret.WebSocket).type = egret.WebSocket.TYPE_BINARY, s.addEventListener(egret.ProgressEvent.SOCKET_DATA, l, this), s.addEventListener(egret.Event.CONNECT, g, this), s.addEventListener(egret.Event.CLOSE, m, this), s.addEventListener(egret.IOErrorEvent.IO_ERROR, u, this), s.connectByUrl(e)
            }()
        }, e.MatchvsHttp = t), "undefined" != typeof wx ? (console.log("network api->wx"), e.MatchvsNetWork = function (e, t) {
            this.socket = wx.connectSocket({url: e, header: {engine: "WeiXinGame"}});
            var r = !1;
            this.socketOpen = !1;
            var o = [], s = t, i = e, a = this;
            this.close = function () {
                this.socket && (r = !0, this.socket.close({code: 1e3, reason: "normal"}))
            }, this.send = function (e) {
                this.socketOpen ? this.socket.send({data: e.buffer}) : o.length < 100 && o.unshift(e)
            }, this.socket.onOpen(function (e) {
                for (MatchvsLog.logI("[wx.WebSocket][connect]:" + e), a.socketOpen = !0; 0 < o.length;) a.send(o.pop());
                s.onConnect && s.onConnect(i)
                ...
                a.socketOpen = !1, e && e.reason && "interrupted" == e.reason && (e.code = 1001), 0 == r && (e.code = 1001, MatchvsLog.logI("Not BeClosed by User ")), s.onDisConnect && s.onDisConnect(i, e)
            }), this.socket.onMessage(function (e) {
                var t = new DataView(e.data);
                s.onMsg(t)
            }), this.socket.onError(function (e) {
                MatchvsLog.logI("[wx.WebSocket] [onError] case:" + e), s.onDisConnect && s.onDisConnect(i, e)
            })
            ...
            this.send = function (e) {
                ...
                65535 === t.code && (t.code = 1e3), i.onDisConnect && i.onDisConnect(r, t), MatchvsLog.logI("[BK.WebSocket] [onError][Matchvs] case:" + e)
            ...
            function r(o, s, e, t) {
                var r = e ? "application/json" : "application/x-www-form-urlencoded", i = new BK.HttpUtil(o);
                i.setHttpMethod(e ? "post" : "get"), i.setHttpHeader("Content-type", r), i.requestAsync(function (e, t) {
                    if (200 === t) {
                        var r = e.readAsString(!0);
                        s.onMsg(r), MatchvsLog.logI("[HTTP:](" + o + ")+" + r)
                    } else s.onErr(t, e.readAsString(!0))
                }), e ? i.setHttpPostData(t) : i.setHttpUrl(o)
            }
    ...
    n[u.SPEEDRSP] = c.SpeedRsp, n[u.LOGINRSP] = c.LoginRsp, n[u.JOINROOMRSP] = c.JoinRoomRsp, n[u.CHECKINACKCMDID] = c.CheckInAck, n[u.CREATEROOMRSP] = c.CreateRoomRsp, n[u.CHECKINNOTIFYCMDID] = c.CheckInNotify, n[u.JOINOVERRSP] = c.JoinOverRsp, n[u.LEAVEROOMRSP] = c.LeaveRoomRsp, n[u.NOTICEUSERJOINREQ] = c.NoticeJoin, n[u.HEARTBEATACKCMDID] = c.HeartbeatAck, n[u.NOTICEUSERLEAVEREQ] = c.NoticeLeave, n[u.BROADCASTACKCMDID] = c.BroadcastAck, n[u.NOTIFYCMDID] = c.Notify, n[u.SUBSCRIBEACKCMDID] = c.SubscribeAck, n[u.PUBLISHACKCMDID] = c.PublishAck, n[u.PUBLISHNOTIFYCMDID] = c.PublishNotify, n[u.HEARTBEATREQ] = c.HeartbeatRsp, n[u.GETROOMLISTRSP] = c.GetRoomListRsp, n[u.LOGOUTRSP] = c.LogoutRsp, n[u.KICKPLAYERNOTIFY] = c.KickPlayerNotify, n[u.KICKPLAYERRSP] = c.KickPlayerRsp, n[u.SETFRAMESYNCRATEACKCMDID] = c.SetFrameSyncRateAck, n[u.FRAMEBROADCASTACKCMDID] = c.FrameBroadcastAck, n[u.SETFRAMESYNCRATENOTIFYCMDID] = c.SetFrameSyncRateNotify, n[u.FRAMEDATANOTIFYCMDID] = c.FrameDataNotify, n[u.NOTICEROOMNETWORKSTATE] = c.RoomNetworkStateNotify, n[u.FRAMESYNCNOTIFYCMDID] = c.FrameSyncNotify, n[u.ROOMLISTEXRSP] = c.GetRoomListExRsp, n[u.JOINOVERNOTIFY] = c.JoinOverNotify, n[u.GETROOMDETAILRSP] = c.GetRoomDetailRsp, n[u.SETROOMPROPERTYRSP] = c.SetRoomPropertyRsp, n[u.NOTICEROOMPROPERTY] = c.NoticeRoomProperty, n[u.JOINOPENRSP] = c.JoinOpenRsp, n[u.JOINOPENNOTIFY] = c.JoinOpenNotify, n[u.JOINWATCHROOMRSP] = c.JoinWatchRoomRsp, n[u.ENTERLIVEROOMACKCMDID] = c.EnterLiveRoomAck, n[u.ENTERLIVEROOMNOTIFYCMDID] = c.EnterLiveRoomNotify, n[u.LIVEHEARTBEATACKCMDID] = c.LiveHeartbeatAck, n[u.LIVEBROADCASTACKCMDID] = c.LiveBroadcastAck, n[u.LIVEBROADCASTNOTIFYCMDID] = c.LiveBroadcastNotify, n[u.SETLIVEOFFSETACKCMDID] = c.SetLiveOffsetAck, n[u.EXITLIVEROOMNOTIFYCMDID] = c.ExitLiveRoomNotify, n[u.LIVEOVERNOTIFYCMDID] = c.LiveOverNotify, n[u.LIVEFRAMEDATANOTIFYCMDID] = c.LiveFrameDataNotify, n[u.LIVEFRAMESYNCNOTIFYCMDID] = c.LiveFrameSyncNotify, n[u.LEAVEWATCHROOMRSP] = c.LeaveWatchRoomRsp, n[u.GETWATCHROOMSRSP] = c.GetWatchRoomsRsp, n[u.CHANGEROLERSP] = c.ChangeRoleRsp, n[u.SETRECONNECTTIMEOUTRSP] = c.SetReconnectTimeoutRsp, n[u.CREATETEAMRSP] = c.CreateTeamRsp, n[u.JOINTEAMRSP] = c.JoinTeamRsp, n[u.JOINTEAMNOTIFY] = c.JoinTeamNotify, n[u.LEAVETEAMRSP] = c.LeaveTeamRsp, n[u.LEAVETEAMNOTIFY] = c.LeaveTeamNotify, n[u.TEAMMATCHRSP] = c.TeamMatchRsp, n[u.TEAMMATCHRESULTNOTIFY] = c.TeamMatchResultNotify, n[u.TEAMMATCHSTARTNOTIFY] = c.TeamMatchStartNotify, n[u.GETCACHEDATACMDIDACKCMDID] = c.GetCacheDataAck, n[u.CANCELTEAMMATCHRSP] = c.CancelTeamMatchRsp, n[u.CANCELTEAMMATCHNOTIFY] = c.CancelTeamMatchNotify, n[u.KICKTEAMMEMBERRSP] = c.KickTeamMemberRsp, n[u.KICKTEAMMEMBERNOTIFY] = c.KickTeamMemberNotify, n[u.SENDTEAMEVENTRSP] = c.SendTeamEventRsp, n[u.SENDTEAMEVENTNOTIFY] = c.SendTeamEventNotify, n[u.SETTEAMUSERPROFILERSP] = c.SetTeamUserProfileRsp, n[u.NOTICETEAMUSERPROFILE] = c.NoticeTeamUserProfile, n[u.SETTEAMPROPERTYRSP] = c.SetTeamPropertyRsp, n[u.NOTICETEAMPROPERTY] = c.NoticeTeamProperty, n[u.SETTEAMRECONNECTTIMEOUTRSP] = c.SetTeamReconnectTimeoutRsp, n[u.NOTICETEAMNETWORKSTATE] = c.TeamNetworkStateNotify, e.MatchvsProtocol = function () {
        ...
        this.fillHeader = function (e, t) {
            ...
            for (var t = e, r = this.parseHeader(e), o = new Uint8Array(r.size - 16), s = 0; s < o.length; s++) o[s] = e.getUint8(16 + s);
            var i = n[r.cmd], a = new Packet;
            return a.header = r, a.buf = t, i ? (MatchvsLog.logD("[INFO]  " + r.cmd), a.payload = i.deserializeBinary && i.deserializeBinary(e.buffer.slice(16, e.buffer.byteLength))) : MatchvsLog.logI("[WARN]unknown msg,Head:" + r), a
        }, this.init = function () {
        }, this.speed = function (e) {
            var t = new c.SpeedReq;
            t.setGameid(e.gameID), t.setEchodata(stringToUtf8ByteArray(e.echoData)), t.setGameversion(String(e.gameVersion)), t.setUserid(123456), t.setSdkversion(String(2));
            var r = t.serializeBinary();
            return this.fillHeader(r, u.SPEEDREQ)
        }, this.login = function (e, t, r, o, s) {
            var i = hex_md5(t), a = format("%s&UserID=%s&GameID=%s&VersionSdk=%d&%s", o, e, r, 3, i);
            m = e;
            var n = hex_md5(a);
            MatchvsLog.logI("[Sign]" + a + "->" + n);
            var p = new c.LoginReq;
            p.setGameid(Number(r)), p.setAppkey(o), p.setToken(i), p.setSdkver("3"), p.setDeviceid(s), p.setSign(n);
            var g = p.serializeBinary();
            return MatchvsLog.logI("[REQ]login...userID:" + e), l = !0, this.fillHeader(g, u.LOGINREQ)
        }, this.roomCreate = function (e, t, r, o) {
            var s = new c.CreateRoom;
            s.setGameid(Number(e));
            var i = new c.PlayerInfo;
            i.setUserid(r.userID), i.setUserprofile(stringToUtf8ByteArray(r.userProfile)), s.setPlayerinfo(i);
            var a = new c.RoomInfo;
            ...
            return this.fillHeader(p, u.CREATEROOMREQ)
        }, this.joinRandomRoom = function (e) {
            var t = new c.JoinRoomReq;
            t.setGameid(Number(e.gameID)), t.setJointype(c.JoinRoomType.JOINRANDOMROOM), t.setCpproto(stringToUtf8ByteArray(e.userProfile));
            var r = new c.PlayerInfo;
            r.setUserid(e.userID), r.setUserprofile(stringToUtf8ByteArray(e.userProfile)), t.setPlayerinfo(r);
            var o = new c.RoomInfo;
            o.setMaxplayer(e.maxPlayer), o.setCanwatch(e.canWatch), o.setMode(e.mode), o.setVisibility(e.visibility ? e.visibility : 1), t.setRoominfo(o);
            var s = t.serializeBinary();
            return this.fillHeader(s, u.JOINROOMREQ)
            ...
            r.setUserid(e.userID), r.setUserprofile(stringToUtf8ByteArray(e.userProfile)), t.setPlayerinfo(r);
            var o = new c.RoomInfo;
            o.setMaxplayer(e.maxPlayer), o.setCanwatch(e.canWatch), o.setMode(e.mode), o.setVisibility(0), o.setRoomid(e.roomID), o.setRoomproperty(stringToUtf8ByteArray(e.roomProperty || "")), t.setRoominfo(o);
            var s = t.serializeBinary();
            return this.fillHeader(s, u.JOINROOMREQ)
        }, this.joinRoomWithProperties = function (e, t) {
            var r = new c.JoinRoomReq, o = [], s = e.tags, i = 0;
            for (var a in s) {
                var n = new c.keyValue;
                n.setKey(a), n.setValue(s[a]), o[i++] = n
            }
            r.setTagsList(o), r.setGameid(e.gameID), r.setJointype(c.JoinRoomType.JOINROOMWITHPROPERTY), r.setCpproto(stringToUtf8ByteArray(e.userProfile));
            var p = new c.PlayerInfo;
            p.setUserid(e.userID), p.setUserprofile(stringToUtf8ByteArray(e.userProfile)), r.setPlayerinfo(p);
            var g = new c.RoomInfo;
            if (g.setMaxplayer(e.maxPlayer), g.setCanwatch(e.canWatch), g.setMode(e.mode), g.setVisibility(e.visibility), g.setRoomproperty(stringToUtf8ByteArray(e.roomProperty || "")), g.setRoomid(e.roomID), r.setRoominfo(g), t) {
                var m = new c.WatchSetting;
                m.setCachetime(t.cacheMS), m.setMaxwatch(t.maxWatch), m.setWatchdelayms(t.delayMS), m.setWatchpersistent(t.persistent), r.setWatchsetting(m)
            }
            var l = r.serializeBinary();
            return this.fillHeader(l, u.JOINROOMREQ)
            ...
            return this.fillHeader(i, u.CHECKINCMDID)
        }, this.getRoomList = function (e, t) {
            var r = new c.GetRoomList, o = new c.RoomFilter;
            ...
            return this.fillHeader(s, u.GETROOMLISTREQ)
        }, this.getRoomListEx = function (e, t) {
            var r = new c.GetRoomListExReq, o = new c.RoomFilter;
            o.setMaxplayer(t.maxPlayer), o.setMode(Number(t.mode)), o.setFull(t.full), o.setCanwatch(t.canWatch), o.setRoomproperty(stringToUtf8ByteArray(t.roomProperty)), o.setState(t.state), o.setGetsystemroom(t.getSystemRoom || 0), r.setGameid(e), r.setRoomfilter(o), r.setSort(t.sort), r.setOrder(t.order), r.setPageno(t.pageNo), r.setPagesize(t.pageSize);
            var s = r.serializeBinary();
            return this.fillHeader(s, u.ROOMLISTEXREQ)
        }, this.getRoomDetail = function (e, t) {
            var r = new c.GetRoomDetailReq;
            r.setGameid(e), r.setRoomid(t);
            var o = r.serializeBinary();
            return this.fillHeader(o, u.GETROOMDETAILREQ)
        }, this.joinOver = function (e, t, r, o) {
            var s = new c.JoinOverReq;
            s.setGameid(e), s.setRoomid(t), s.setCpproto(r), s.setUserid(o);
            var i = s.serializeBinary();
            return this.fillHeader(i, u.JOINOVERREQ)
        }, this.leaveRoom = function (e, t, r, o) {
            var s = new c.LeaveRoomReq;
            s.setGameid(e), s.setUserid(t), s.setRoomid(r), s.setCpproto(stringToUtf8ByteArray(o));
            var i = s.serializeBinary();
            return this.fillHeader(i, u.LEAVEROOMREQ)
        }, this.heartBeat = function (e, t) {
            var r = new c.HeartbeatReq;
            r.setGameid(e), r.setRoomid(t);
            var o = r.serializeBinary();
            return this.fillHeader(o, u.HEARTBEATREQ)
        }, this.logout = function (e) {
            var t = stringToUtf8ByteArray(e);
            return this.fillHeader(t, u.LOGOUTREQ)
        }, this.broadCast = function (e, t, r, o, s) {
            var i = new c.Broadcast;
            i.setRoomid(e), i.setDstuidsList(t), i.setCpproto(s);
            var a = 32 + ((3 & r) << 2) + (3 & o);
            i.setFlag(a);
            var n = i.serializeBinary();
            return this.fillHeader(n, u.BROADCASTCMDID)
        }, this.subscribeEventGroup = function (e, t, r, o) {
            var s = new c.Subscribe;
            s.setRoomid(t), s.setGameid(e), s.setCancelsList(o), s.setConfirmsList(r);
            var i = s.serializeBinary();
            return this.fillHeader(i, u.SUBSCRIBECMDID)
            ...
            return this.fillHeader(a, u.PUBLISHCMDID)
        }, this.hotelHeartBeat = function (e, t, r) {
            var o = new c.Heartbeat;
            o.setGameid(e), o.setRoomid(t), o.setUserid(r);
            var s = o.serializeBinary();
            return this.fillHeader(s, u.HEARTBEATCMDID)
        }, this.kickPlayer = function (e, t, r, o) {
            var s = new c.KickPlayer;
            s.setRoomid(r), s.setSrcuserid(t), s.setUserid(e), s.setCpproto(stringToUtf8ByteArray(o));
            var i = s.serializeBinary();
            return this.fillHeader(i, u.KICKPLAYERREQ)
        }, this.setFrameSync = function (e) {
            var t = new c.SetFrameSyncRate;
            MatchvsLog.logD("SetFrameSyncRate :" + JSON.stringify(e)), t.setGameid(e.gameID), t.setRoomid(e.roomID), t.setPriority(e.priority), t.setFramerate(e.frameRate), t.setFrameidx(e.frameidx), t.setEnablegs(e.enableGS), t.setCacheframems(e.cacheMs);
            var r = t.serializeBinary();
            return this.fillHeader(r, u.SETFRAMESYNCRATECMDID)
        }, this.sendFrameEvent = function (e, t, r, o, s) {
            var i = new c.FrameBroadcast;
            i.setRoomid(e), i.setPriority(t), i.setOperation(o), i.setCpproto(stringToUtf8ByteArray(r, s));
            var a = i.serializeBinary();
            return this.fillHeader(a, u.FRAMEBROADCASTCMDID)
        }, this.setRoomProperty = function (e, t, r, o) {
            var s = new c.SetRoomPropertyReq;
            s.setGameid(e), s.setRoomid(r), s.setUserid(t), s.setRoomproperty(stringToUtf8ByteArray(o));
            var i = s.serializeBinary();
            return this.fillHeader(i, u.SETROOMPROPERTYREQ)
        }, this.joinOpen = function (e, t, r, o) {
            var s = new c.JoinOpenReq;
            s.setRoomid(r), s.setGameid(e), s.setUserid(t), s.setCpproto(stringToUtf8ByteArray(o));
            var i = s.serializeBinary();
            return this.fillHeader(i, u.JOINOPENREQ)
        }, this.joinWatchRoom = function (e, t, r, o) {
            var s = new c.JoinWatchRoomReq;
            s.setGameid(e), s.setRoomid(r), s.setUserid(t), s.setUserprofile(stringToUtf8ByteArray(o));
            var i = s.serializeBinary();
            return this.fillHeader(i, MVS.PtoCmd.JOINWATCHROOMREQ)
        }, this.enterLiveRoom = function (e, t, r, o, s) {
            var i = new c.EnterLiveRoom;
            i.setBookid(e.getBookid()), i.setTicket(e.getBookkey()), i.setGameid(t), i.setUserid(r), i.setSetid(s), i.setUserprofile(""), i.setRoomid(o);
            var a = i.serializeBinary();
            return this.fillHeader(a, c.SDKWatchCmdID.ENTERLIVEROOMCMDID)
        }, this.leaveWatchRoom = function (e, t, r, o) {
            var s = new c.LeaveWatchRoomReq;
            s.setCpproto(stringToUtf8ByteArray(o)), s.setGameid(e), s.setUserid(t), s.setRoomid(r);
            var i = s.serializeBinary();
            return this.fillHeader(i, MVS.PtoCmd.LEAVEWATCHROOMREQ)
        }, this.getWatchRooms = function (e, t) {
            var r = new c.GetWatchRoomsReq, o = new c.RoomFilter;
            ...
            var s = r.serializeBinary();
            return this.fillHeader(s, MVS.PtoCmd.GETWATCHROOMSREQ)
        }, this.liveHeartBeat = function (e, t, r) {
            var o = new c.LiveHeartbeat;
            o.setGameid(Number(e)), o.setRoomid(t), o.setUserid(Number(r));
            var s = o.serializeBinary();
            return this.fillHeader(s, c.SDKWatchCmdID.LIVEHEARTBEATCMDID)
        }, this.broadCastWatch = function (e, t, r, o, s) {
            var i = new c.LiveBroadcast;
            i.setRoomid(e), i.setDstuidsList(t), i.setCpproto(stringToUtf8ByteArray(s));
            var a = 32 + ((3 & r) << 2) + (3 & o);
            i.setFlag(a);
            var n = i.serializeBinary();
            return this.fillHeader(n, c.SDKWatchCmdID.LIVEBROADCASTCMDID)
        }, this.setLiveOffset = function (e, t, r, o) {
            var s = new c.SetLiveOffset;
            s.setGameid(e), s.setRoomid(t), s.setUserid(r), s.setOffsetms(o);
            var i = s.serializeBinary();
            return this.fillHeader(i, MVS.PtoCmd.SETLIVEOFFSETCMDID)
        }, this.changeRoleProto = function (e, t, r, o, s) {
            var i = new c.ChangeRole;
            i.setGameid(t), i.setRoomid(r), i.setUserid(e), i.setUserprofile(stringToUtf8ByteArray(s));
            var a = 0 === o ? c.RoomType.GAMEROOMTYPE : c.RoomType.WATCHROOMTYPE;
            i.setTargetroomtype(a);
            var n = i.serializeBinary();
            return this.fillHeader(n, MVS.PtoCmd.CHANGEROLEREQ)
        }, this.setReconnectTimeout = function (e, t) {
            var r = new c.SetReconnectTimeoutReq;
            r.setTimeout(Number(t)), r.setUserid(Number(e));
            var o = r.serializeBinary();
            return this.fillHeader(o, MVS.PtoCmd.SETRECONNECTTIMEOUTREQ)
        }, this.setTeamReconnectTimeout = function (e, t) {
            var r = new c.SetTeamReconnectTimeoutReq;
            r.setTimeout(Number(t)), r.setUserid(Number(e));
            var o = r.serializeBinary();
            return this.fillHeader(o, MVS.PtoCmd.SETTEAMRECONNECTTIMEOUTREQ)
        }, this.CreateTeam = function (e, t, r) {
            MatchvsLog.logD("CreateTeam gameID:", e, " teamInfo:", t);
            var o = new c.TeamInfo;
            o.setCapacity(t.capacity), o.setTeamid(t.teamID), o.setPassword(t.password), o.setMode(t.mode), o.setOwner(t.owner), o.setVisibility(t.visibility), o.setTeamproperty(stringToUtf8ByteArray(t.teamProperty));
            var s = new c.PlayerInfo;
            s.setUserid(r.userID), s.setUserprofile(stringToUtf8ByteArray(r.userProfile));
            var i = new c.CreateTeamReq;
            i.setGameid(Number(e)), i.setPlayerinfo(s), i.setTeaminfo(o);
            var a = i.serializeBinary();
            return this.fillHeader(a, MVS.PtoCmd.CREATETEAMREQ)
        }, this.SetTeamProperty = function (e) {
            MatchvsLog.logD("setTeamProperty teamInfo:", e);
            var t = new c.SetTeamPropertyReq;
            t.setGameid(e.gameID), t.setTeamid(e.teamID), t.setUserid(e.userID), t.setTeamproperty(stringToUtf8ByteArray(e.teamProperty));
            var r = t.serializeBinary();
            return this.fillHeader(r, MVS.PtoCmd.SETTEAMPROPERTYREQ)
        }, this.setTeamUserProfile = function (e) {
            MatchvsLog.logD("setTeamProperty teamInfo:", e);
            var t = new c.SetTeamUserProfileReq;
            t.setGameid(e.gameID), t.setTeamid(e.teamID), t.setUserid(e.userID), t.setUserprofile(stringToUtf8ByteArray(e.userProfile));
            var r = t.serializeBinary();
            return this.fillHeader(r, MVS.PtoCmd.SETTEAMUSERPROFILEREQ)
        }, this.JoinTeam = function (e) {
            var t = new c.PlayerInfo;
            t.setUserid(e.player.userID), t.setUserprofile(stringToUtf8ByteArray(e.player.userProfile));
            var r = new c.JoinTeamReq;
            r.setGameid(e.gameID), r.setTeamid(e.teamID), r.setPlayerinfo(t), r.setPassword(e.password), r.setJointype(e.joinType);
            var o = r.serializeBinary();
            return this.fillHeader(o, MVS.PtoCmd.JOINTEAMREQ)
        }, this.LeaveTeam = function (e) {
            MatchvsLog.logD("LeaveTeam args:", e);
            var t = new c.LeaveTeamReq;
            t.setGameid(Number(e.gameID)), t.setTeamid(e.teamID), t.setUserid(Number(e.userID));
            var r = t.serializeBinary();
            return this.fillHeader(r, MVS.PtoCmd.LEAVETEAMREQ)
        }, this.TeamMatch = function (e) {
            MatchvsLog.logD("TeamMatch args:", e);
            var t = new c.TeamMatchCond;
            ...
            for (var s in r) {
                var i = new c;
                i.setKey(s), i.setValue(r[s]), o.push(i)
            }
            t.setTagsList(o);
            var a = new c.WatchSetting;
            a.setWatchpersistent(e.watchSet.persistent), a.setWatchdelayms(e.watchSet.delayMS), a.setMaxwatch(e.watchSet.maxWatch), a.setCachetime(e.watchSet.cacheMS);
            var n = new c.RoomInfo;
            n.setRoomproperty(stringToUtf8ByteArray(e.roomInfo.roomProperty)), n.setCanwatch(e.roomInfo.canWatch), n.setMaxplayer(e.roomInfo.maxPlayer), n.setMode(e.roomInfo.mode), n.setOwner(0), n.setRoomid(""), n.setRoomname(e.roomInfo.roomName), n.setVisibility(e.roomInfo.visibility);
            var p = new c.TeamMatchReq;
            p.setGameid(e.gameID), p.setTeamid(e.teamID), p.setUserid(e.userID), p.setCond(t), p.setRoominfo(n), p.setWatchsetting(a);
            var g = p.serializeBinary();
            return this.fillHeader(g, MVS.PtoCmd.TEAMMATCHREQ)
        }, this.GetOffLineData = function (e) {
            var t = new c.GetCacheData;
            t.setCacheframems(e.cacheFrameMS), t.setRoomid(e.roomID), t.setGameid(e.gameID);
            var r = t.serializeBinary();
            return this.fillHeader(r, MVS.PtoCmd.GETCACHEDATACMDID)
        }, this.CancelTeamMatch = function (e) {
            var t = new c.CancelTeamMatchReq;
            t.setGameid(e.gameID), t.setTeamid(e.teamID), t.setCpproto(stringToUtf8ByteArray(e.cpProto)), t.setUserid(e.userID);
            var r = t.serializeBinary();
            return this.fillHeader(r, MVS.PtoCmd.CANCELTEAMMATCHREQ)
        }, this.SendTeamEvent = function (e) {
            var t = new c.SendTeamEventReq;
            ...
            var r = t.serializeBinary();
            return this.fillHeader(r, MVS.PtoCmd.SENDTEAMEVENTREQ)
        }, this.KickTeamMember = function (e) {
            var t = new c.KickTeamMemberReq;
            ...
            var r = t.serializeBinary();
            return this.fillHeader(r, MVS.PtoCmd.KICKTEAMMEMBERREQ)
        }
    }
}(MVS || {});
...
function MatchvsResponse() {
    ...
    }, this.teamNetworkStateNotify = function (e) {
    ...
    }, this.setTeamReconnectTimeoutResponse = function (e) {
...
!function (e) {
    e.EngineNetworkMap = function () {
        this[MVS.PtoCmd.SPEEDRSP] = new t, this[MVS.PtoCmd.LOGINRSP] = new r, this[MVS.PtoCmd.CREATEROOMRSP] = new i, this[MVS.PtoCmd.JOINROOMRSP] = new o, this[MVS.PtoCmd.NOTICEUSERJOINREQ] = new s, this[MVS.PtoCmd.JOINOVERRSP] = new g, this[MVS.PtoCmd.JOINOVERNOTIFY] = new l, this[MVS.PtoCmd.JOINOPENRSP] = new C, this[MVS.PtoCmd.JOINOPENNOTIFY] = new A, this[MVS.PtoCmd.LEAVEROOMRSP] = new p, this[MVS.PtoCmd.NOTICEUSERLEAVEREQ] = new u, this[MVS.PtoCmd.HEARTBEATREQ] = new M, this[MVS.PtoCmd.LOGOUTRSP] = new b, this[MVS.PtoCmd.KICKPLAYERNOTIFY] = new E, this[MVS.PtoCmd.KICKPLAYERRSP] = new S, this[MVS.PtoCmd.GETROOMLISTRSP] = new T, this[MVS.PtoCmd.ROOMLISTEXRSP] = new O, this[MVS.PtoCmd.GETROOMDETAILRSP] = new _, this[MVS.PtoCmd.SETROOMPROPERTYRSP] = new N, this[MVS.PtoCmd.NOTICEROOMPROPERTY] = new w, this[MVS.PtoCmd.CHECKINACKCMDID] = new a, this[MVS.PtoCmd.CHECKINNOTIFYCMDID] = new n, this[MVS.PtoCmd.HEARTBEATACKCMDID] = new c, this[MVS.PtoCmd.BROADCASTACKCMDID] = new d, this[MVS.PtoCmd.NOTIFYCMDID] = new f, this[MVS.PtoCmd.SUBSCRIBEACKCMDID] = new h, this[MVS.PtoCmd.PUBLISHNOTIFYCMDID] = new y, this[MVS.PtoCmd.PUBLISHNOTIFYCMDID] = new R, this[MVS.PtoCmd.SETFRAMESYNCRATEACKCMDID] = new I, this[MVS.PtoCmd.FRAMEBROADCASTACKCMDID] = new F, this[MVS.PtoCmd.SETFRAMESYNCRATENOTIFYCMDID] = new v, this[MVS.PtoCmd.FRAMEDATANOTIFYCMDID] = new B, this[MVS.PtoCmd.FRAMESYNCNOTIFYCMDID] = new D, this[MVS.PtoCmd.NOTICEROOMNETWORKSTATE] = new W, this[MVS.PtoCmd.JOINWATCHROOMRSP] = new P, this[MVS.PtoCmd.LEAVEWATCHROOMRSP] = new U, this[MVS.PtoCmd.GETWATCHROOMSRSP] = new k, this[MVS.PtoCmd.CHANGEROLERSP] = new K, this[MVS.PtoCmd.ENTERLIVEROOMACKCMDID] = new L, this[MVS.PtoCmd.ENTERLIVEROOMNOTIFYCMDID] = new j, this[MVS.PtoCmd.LIVEHEARTBEATACKCMDID] = new G, this[MVS.PtoCmd.LIVEBROADCASTACKCMDID] = new z, this[MVS.PtoCmd.LIVEBROADCASTNOTIFYCMDID] = new x, this[MVS.PtoCmd.SETLIVEOFFSETACKCMDID] = new H, this[MVS.PtoCmd.EXITLIVEROOMNOTIFYCMDID] = new q, this[MVS.PtoCmd.LIVEOVERNOTIFYCMDID] = new V, this[MVS.PtoCmd.LIVEFRAMEDATANOTIFYCMDID] = new J, this[MVS.PtoCmd.LIVEFRAMESYNCNOTIFYCMDID] = new $, this[MVS.PtoCmd.SETRECONNECTTIMEOUTRSP] = new Y, this[MVS.PtoCmd.CREATETEAMRSP] = new X, this[MVS.PtoCmd.JOINTEAMRSP] = new Q, this[MVS.PtoCmd.JOINTEAMNOTIFY] = new Z, this[MVS.PtoCmd.LEAVETEAMRSP] = new ee, this[MVS.PtoCmd.LEAVETEAMNOTIFY] = new te, this[MVS.PtoCmd.TEAMMATCHRSP] = new re, this[MVS.PtoCmd.TEAMMATCHRESULTNOTIFY] = new oe, this[MVS.PtoCmd.TEAMMATCHSTARTNOTIFY] = new se, this[MVS.PtoCmd.SETTEAMPROPERTYRSP] = {
            doSubHandle: function (e, t) {
                console.log("[INFO]  " + e), t.mRsp.setTeamPropertyResponse && t.mRsp.setTeamPropertyResponse({
                    status: e.payload.getStatus(),
                    teamID: e.payload.getTeamid(),
                    userID: e.payload.getUserid(),
                    teamProperty: utf8ByteArrayToString(e.payload.getTeamproperty())
                })
            }
        }, this[MVS.PtoCmd.NOTICETEAMPROPERTY] = {
            doSubHandle: function (e, t) {
                t.mRsp.setTeamPropertyNotify && t.mRsp.setTeamPropertyNotify({
                    teamID: e.payload.getTeamid(),
                    userID: e.payload.getUserid(),
                    teamProperty: utf8ByteArrayToString(e.payload.getTeamproperty())
                })
            }
        }, this[MVS.PtoCmd.SETTEAMUSERPROFILERSP] = {
            doSubHandle: function (e, t) {
                t.mRsp.setTeamUserProfileResponse && t.mRsp.setTeamUserProfileResponse({
                    status: e.payload.getStatus(),
                    teamID: e.payload.getTeamid(),
                    userID: e.payload.getUserid(),
                    userProfile: utf8ByteArrayToString(e.payload.getUserprofile())
                })
            }
        }, this[MVS.PtoCmd.NOTICETEAMUSERPROFILE] = {
            doSubHandle: function (e, t) {
                t.mRsp.setTeamUserProfileNotify && t.mRsp.setTeamUserProfileNotify({
                    teamID: e.payload.getTeamid(),
                    userID: e.payload.getUserid(),
                    userProfile: utf8ByteArrayToString(e.payload.getUserprofile())
                })
            }
        }, this[MVS.PtoCmd.SETTEAMRECONNECTTIMEOUTRSP] = {
            doSubHandle: function (e, t) {
                var r = e.payload.getStatus();
                200 !== r && m(t.mRsp.errorResponse, r, " set reconnect timeout value response error"), t.mRsp.setTeamReconnectTimeoutResponse && t.mRsp.setTeamReconnectTimeoutResponse(r)
            }
        }, this[MVS.PtoCmd.NOTICETEAMNETWORKSTATE] = {
            doSubHandle: function (e, t) {
                t.mRsp.teamNetworkStateNotify && t.mRsp.teamNetworkStateNotify({
                    teamID: e.payload.getTeamid(),
                    userID: e.payload.getUserid(),
                    state: e.payload.getState(),
                    owner: e.payload.getOwner()
                })
            }
        }, this[MVS.PtoCmd.GETCACHEDATACMDIDACKCMDID] = new ie, this[MVS.PtoCmd.CANCELTEAMMATCHRSP] = new ae, this[MVS.PtoCmd.CANCELTEAMMATCHNOTIFY] = new ne, this[MVS.PtoCmd.KICKTEAMMEMBERRSP] = new me, this[MVS.PtoCmd.KICKTEAMMEMBERNOTIFY] = new le, this[MVS.PtoCmd.SENDTEAMEVENTRSP] = new pe, this[MVS.PtoCmd.SENDTEAMEVENTNOTIFY] = new ge
    };
    ...
    function r() {
        this.doSubHandle = function (e, t) {
            var r = e.payload.getStatus();
            if (MVS.ccReport && MVS.ccReport.loginRsp(r), 200 === r) if (t.mState.SetLogin(), t.mRecntRoomID = e.payload.getRoomid(), t.mRecntTeamID = e.payload.getTeamid(), 0 !== t.mState.IsReconnecting()) {
                if ("0" !== t.mRecntRoomID) {
                ...
                "0" !== t.mRecntTeamID && (MatchvsLog.logI("ReConnectTeamID:", t.mRecntTeamID), t.mProtocol && t.joinTeam({
                    teamID: t.mRecntTeamID,
                    password: "",
                    userProfile: "reconnect",
                    joinType: 1
                }))
            } else t.mRsp.loginResponse(new MsLoginRsp(r, t.mRecntRoomID, t.mRecntTeamID)); else t.mState.SetInit(), m(t.mRsp.errorResponse, r, "login or reconnect is fail")
        }
    }
    ...
    function o() {
        this.doSubHandle = function (e, r) {
            ...
            } else r.mState.DelJoinRooming(), m(r.mRsp.errorResponse, t, "join room failed "), r.mRsp.joinRoomResponse && r.mRsp.joinRoomResponse(t, null, null)
        }
    }
    ...
    function s() {
        this.doSubHandle = function (e, t) {
            ...
            t.joinRoomNotifyInfo[r] = new MsRoomUserInfo(r, utf8ByteArrayToString(e.payload.getUser().getUserprofile())), MatchvsLog.logI(" JoinRoomNotifyWork :" + r)
        }
    }
    ...
    function i() {
        this.doSubHandle = function (e, t) {
            ...
            } else t.mState.DelCreateRoom(), m(t.mRsp.errorResponse, e.payload.getStatus(), ""), t.mRsp.createRoomResponse && t.mRsp.createRoomResponse(new MsCreateRoomRsp(e.payload.getStatus(), "", 0))
        }
    }

    function a() {
        this.doSubHandle = function (e, t) {
            var r = e.payload.getCheckinsList(), o = e.payload.getStatus();
            if (200 !== o) t.mState.SetLogin(), m(t.mRsp.errorResponse, o, "check in error"), t.mHotelNetWork && t.mHotelNetWork.close(); else {
    ...
    function p() {
        this.doSubHandle = function (e, t) {
            t.mState.DelInRoom(), 200 !== e.payload.getStatus() && m(t.mRsp.errorResponse, e.payload.getStatus(), "leave room fail"), e.roomInfo.setRoomid("0"), t.mRoomInfo = e.roomInfo;
    ...
    function g() {
        this.doSubHandle = function (e, t) {
            200 !== e.payload.getStatus() && m(t.mRsp.errorResponse, e.payload.getStatus(), "join over fail"), t.mRsp.joinOverResponse && t.mRsp.joinOverResponse(new MsJoinOverRsp(e.payload.getStatus(), utf8ByteArrayToString(e.payload.getCpproto())))
        }
    }
    ...
    function c() {
        this.doSubHandle = function (e, t) {
            t.mRsp.hotelHeartBeatRsp && t.mRsp.hotelHeartBeatRsp(e.payload.getStatus()), MatchvsLog.logD("hotelHeartBeatRsp")
        }
    }

    function d() {
        this.doSubHandle = function (e, t) {
            200 !== e.payload.getStatus() && m(t.mRsp.errorResponse, e.payload.getStatus(), "send event fail"), t.mRsp.sendEventResponse && t.mRsp.sendEventResponse(new MsSendEventRsp(e.payload.getStatus(), e.seq))
        }
    }
    ...
    function M() {
        this.doSubHandle = function (e, t) {
            ...
            t.mRsp && t.mRsp.heartBeatResponse && t.mRsp.heartBeatResponse(new MsHeartBeatResponse(r, o)), MatchvsLog.logD("gatewayHeartBeatResponse")
        }
    }

    function b() {
        this.doSubHandle = function (e, t) {
            t.mGTWNetwork.close(), t.mRsp && t.mRsp.logoutResponse && t.mRsp.logoutResponse(e.payload.getStatus())
        }
    }
    ...
    function T() {
        this.doSubHandle = function (e, t) {
            var r = e.payload.getStatus();
            200 !== r && (t.mRsp && t.mRsp.getRoomListResponse && t.mRsp.getRoomListResponse(e.payload.getStatus(), null), m(t.mRsp && t.mRsp.errorResponse, e.payload.getStatus(), "get room list error "));
            ...
            t.mRsp && t.mRsp.getRoomListResponse && t.mRsp.getRoomListResponse(r, s)
        }
    }

    function S() {
        this.doSubHandle = function (e, t) {
            200 != e.payload.getStatus() && m(t.mRsp.errorResponse, e.payload.getStatus(), "kick player error "), t.mRsp && t.mRsp.kickPlayerResponse && t.mRsp.kickPlayerResponse(new MsKickPlayerRsp(e.payload.getStatus(), e.payload.getOwner(), e.payload.getUserid()))
        }
    }

    function E() {
        this.doSubHandle = function (e, t) {
            e.payload.getUserid().toString() === "" + t.mUserID && null != e.hotelTimer && (MVS.ticker.clearInterval(e.hotelTimer), t.mState.SetLogin(), t.mHotelNetWork.close()), t.mRsp && t.mRsp.kickPlayerNotify && t.mRsp.kickPlayerNotify(new MsKickPlayerNotify(e.payload.getUserid(), e.payload.getSrcuserid(), utf8ByteArrayToString(e.payload.getCpproto()), e.payload.getOwner()))
        }
    }

    function I() {
        this.doSubHandle = function (e, t) {
            MatchvsLog.logI("SetFrameSyncRateAck:" + e.payload), t.mRsp && t.mRsp.setFrameSyncResponse && t.mRsp.setFrameSyncResponse(new MsSetChannelFrameSyncRsp(e.payload.getStatus()))
        }
    }
    ...
    function v() {
        this.doSubHandle = function (e, t) {
            ...
            t.mRsp && t.mRsp.setFrameSyncNotify && t.mRsp.setFrameSyncNotify(r)
        }
    }

    function F() {
        this.doSubHandle = function (e, t) {
            t.mRsp && t.mRsp.sendFrameEventResponse && t.mRsp.sendFrameEventResponse(new MsSendFrameEventRsp(e.payload.getStatus()))
        }
    }
    ...
    function D() {
        this.doSubHandle = function (e, t) {
            ...
            t.mRsp && t.mRsp.frameUpdate && t.mRsp.frameUpdate(o)
        }
    }

    function W() {
        this.doSubHandle = function (e, t) {
            t.mRsp && t.mRsp.networkStateNotify && t.mRsp.networkStateNotify(new MsNetworkStateNotify(e.payload.getRoomid(), e.payload.getUserid(), e.payload.getState(), e.payload.getOwner()))
        }
    }
    ...
    function O() {
        this.doSubHandle = function (e, t) {
            ...
            t.mRsp && t.mRsp.getRoomListExResponse && t.mRsp.getRoomListExResponse(o)
        }
    }

    function _() {
        this.doSubHandle = function (e, t) {
            200 !== e.payload.getStatus() && (t.mRsp.getRoomDetailResponse && t.mRsp.getRoomDetailResponse(new MsGetRoomDetailRsp(e.payload.getStatus())), m(t.mRsp.errorResponse, e.payload.getStatus(), ""));
            ...
            var s = r.getWatchroom(), i = s.getWatchinfo().getWatchsetting(), a = {
            ...
            n.forEach(function (e) {
                ...
                e.getTeamsList().forEach(function (e) {
                    for (var t = e.getTeaminfo(), r = e.getPlayerList(), o = [], s = 0; s < r.length; s++) o[s] = {
    ...
    function N() {
        this.doSubHandle = function (e, t) {
            200 !== e.payload.getStatus() && m(t.mRsp.errorResponse, e.payload.getStatus(), "set room property fail"), t.mRsp && t.mRsp.setRoomPropertyResponse && t.mRsp.setRoomPropertyResponse(new MsSetRoomPropertyRspInfo(e.payload.getStatus(), e.payload.getRoomid(), e.payload.getUserid(), utf8ByteArrayToString(e.payload.getRoomproperty())))
        }
    }

    function w() {
        this.doSubHandle = function (e, t) {
            t.mRsp && t.mRsp.setRoomPropertyNotify && t.mRsp.setRoomPropertyNotify(new MsRoomPropertyNotifyInfo(e.payload.getRoomid(), e.payload.getUserid(), utf8ByteArrayToString(e.payload.getRoomproperty())))
        }
    }

    function C() {
        this.doSubHandle = function (e, t) {
            t.mRsp && t.mRsp.joinOpenResponse && t.mRsp.joinOpenResponse(new MsReopenRoomResponse(e.payload.getStatus(), utf8ByteArrayToString(e.payload.getCpproto())))
        }
    }

    function A() {
        this.doSubHandle = function (e, t) {
            t.mRsp && t.mRsp.joinOpenNotify && t.mRsp.joinOpenNotify(new MsReopenRoomNotify(e.payload.getRoomid(), e.payload.getUserid(), utf8ByteArrayToString(e.payload.getCpproto())))
        }
    }
    ...
    function P() {
        this.doSubHandle = function (e, t) {
            ...
            if (200 !== o) return t.mState.DelJoinWatching(), m(t.mRsp.errorResponse, o, "join watch room error "), void (t.mRsp && t.mRsp.joinWatchRoom && t.mRsp.joinWatchRoom(o));
            var s = r.getBookinfo();
            MatchvsLog.logD("JoinWatchRoomRspWork bookInfo", s), MVS.Host.HOST_WATCH_ADDR = MVS.MsUtil.getLiveUrl(s, MVS.Game.id, r.getRoomid(), r.getSetid()), t.enterLiveRoom(r.getBookinfo(), r.getRoomid())
        }
    }
    ...
    function U() {
        this.doSubHandle = function (e, t) {
            ...
            var r = e.payload;
            MatchvsLog.logD(MVS.LgFormat("LeaveWatchRoomRspWork"), r), 200 !== r.getStatus() && m(t.mRsp.errorResponse(r.getStatus(), " leave watch room error ")), t.mWatchRoomID = "0", t.mRsp && t.mRsp.leaveWatchRoomResponse && t.mRsp.leaveWatchRoomResponse(r.getStatus())
        }
    }
    ...
    function k() {
        this.doSubHandle = function (e, t) {
            var r = e.payload;
            if (200 !== r.getStatus()) return t.mRsp && t.mRsp.getRoomListExResponse && t.mRsp.getRoomListExResponse(new MsGetRoomListExRsp(r.getStatus(), 0, [])), void m(t.mRsp.errorResponse, r.getStatus(), "get watch room list error ");
            ...
            t.mRsp && t.mRsp.getWatchRoomsResponse && t.mRsp.getWatchRoomsResponse(i)
        }
    }
    ...
    function L() {
        this.doSubHandle = function (e, t) {
            ...
            var r = e.payload, o = {};
            if (200 !== r.getStatus()) m(t.mRsp && t.mRsp.errorResponse, r.getStatus(), "enter live room error"), o = new MVS.MsJoinWatchRoomRsp(r.getStatus(), 0, "", {}); else {
                t.mState.SetInWatch();
            ...
            t.mRsp && t.mRsp.joinWatchRoomResponse && t.mRsp.joinWatchRoomResponse(o)
        }
    }
    ...
    function j() {
        this.doSubHandle = function (e, t) {
            ...
            MatchvsLog.logD(MVS.LgFormat("EnterLiveRoomNotifyWork"), r), t.mRsp && t.mRsp.joinWatchRoomNotify && t.mRsp.joinWatchRoomNotify(o)
        }
    }

    function G() {
        this.doSubHandle = function (e, t) {
            t.mRsp && t.mRsp.watchHeartBeat && t.mRsp.watchHeartBeat(e.payload.getStatus())
        }
    }
    ...
    function z() {
        this.doSubHandle = function (e, t) {
            var r = e.payload;
            200 !== r.getStatus() && m(t.mRsp.errorResponse, r.getStatus(), " watch send message error "), t.mRsp && t.mRsp.liveBroadcastResponse && t.mRsp.liveBroadcastResponse(r.getStatus())
        }
    }
    ...
    function x() {
        this.doSubHandle = function (e, t) {
            var r = e.payload;
            t.mRsp && t.mRsp.liveBroadcastNotify && t.mRsp.liveBroadcastNotify(new MsSendEventNotify(r.getSrcuid(), utf8ByteArrayToString(r.getCpproto())))
        }
    }
    ...
    function H() {
        this.doSubHandle = function (e, t) {
            var r = e.payload;
            t.mRsp && t.mRsp.setLiveOffsetResponse && t.mRsp.setLiveOffsetResponse(r.getStatus())
        }
    }
    ...
    function q() {
        this.doSubHandle = function (e, t) {
            ...
            MatchvsLog.logD(MVS.LgFormat("ExitLiveRoomNotifyWork"), o), t.mRsp && t.mRsp.leaveWatchRoomNotify && t.mRsp.leaveWatchRoomNotify(o)
        }
    }
    ...
    function V() {
        this.doSubHandle = function (e, t) {
            var r = e.payload;
            MatchvsLog.logD(MVS.LgFormat("LiveOverNotifyWork"), r), t.mRsp && t.mRsp.liveOverNotify && t.mRsp.liveOverNotify(new MVS.MsLiveOverNotify(r.getGameid(), r.getRoomid()))
        }
    }
    ...
    function $() {
        this.doSubHandle = function (e, t) {
            for (var r = []; 0 < e.frameCache.length;) r.push(e.frameCache.pop());
            var o = new MsFrameData(e.payload.getLastidx(), r, r.length);
            t.mRsp && t.mRsp.liveFrameUpdate && t.mRsp.liveFrameUpdate(o)
        }
    }
    ...
    function K() {
        this.doSubHandle = function (e, t) {
            var r = e.payload;
            if (200 !== r.getStatus()) m(t.mRsp.errorResponse, r.getStatus(), " watch send message error "); else {
                var o = r.getBookinfo();
            ...
            t.mRsp && t.mRsp.changeRoleResponse(new MVS.MsChangeRoleRsp(r.getStatus(), r.getTargetroomtype()))
        }
    }
    ...
    function Y() {
        this.doSubHandle = function (e, t) {
            var r = e.payload.getStatus();
            200 !== r && m(t.mRsp.errorResponse, r, " set reconnect timeout value response error"), t.mRsp && t.mRsp.setReconnectTimeoutResponse && t.mRsp.setReconnectTimeoutResponse(r)
        }
    }
    ...
    function X() {
        this.doSubHandle = function (e, t) {
            var r = e.payload.getStatus();
            200 !== r ? (t.mState.DelInTeam(), m(t.mRsp.errorResponse, r, "create team response error")) : t.mState.SetInTeam(), t.mTeamID = e.payload.getTeamid();
            var o = {status: r, teamID: e.payload.getTeamid(), owner: e.payload.getOwner()};
            t.mRsp && t.mRsp.createTeamResponse && t.mRsp.createTeamResponse(o)
        }
    }
    ...
    function Q() {
        this.doSubHandle = function (e, t) {
            var r = e.payload.getStatus();
            200 !== r ? (t.mState.DelInTeam(), m(t.mRsp.errorResponse, r, "join team response error")) : t.mState.SetInTeam();
            var o = e.payload.getTeaminfo(), s = e.payload.getUsersList(), i = [];
            s.forEach(function (e) {
                i.push({userID: e.getUserid(), userProfile: utf8ByteArrayToString(e.getUserprofile())})
            });
            var a = {team: {}, status: r, userList: i};
            o && (a.team = {
                ...
                mode: o.getMode() || 0,
                owner: o.getOwner() || 0
            }), t.mRsp && t.mRsp.joinTeamResponse && t.mRsp.joinTeamResponse(a)
        }
    }
    ...
    function Z() {
        this.doSubHandle = function (e, t) {
            ...
            t.mRsp && t.mRsp.joinTeamNotify && t.mRsp.joinTeamNotify(o)
        }
    }
    ...
    function ee() {
        this.doSubHandle = function (e, t) {
            var r = e.payload.getStatus();
            200 !== r && m(t.mRsp.errorResponse, r, "leave team response error");
            var o = {status: r, teamID: e.payload.getTeamid() || "0", userID: e.payload.getUserid() || 0};
            t.mRsp && t.mRsp.leaveTeamResponse && t.mRsp.leaveTeamResponse(o)
        }
    }
    ...
    function te() {
        this.doSubHandle = function (e, t) {
            ...
            t.mRsp && t.mRsp.leaveTeamNotify && t.mRsp.leaveTeamNotify(r)
        }
    }
    ...
    function re() {
        this.doSubHandle = function (e, t) {
            var r = e.payload.getStatus();
            200 !== r && m(t.mRsp.errorResponse, r, "team match response error");
            var o = {status: r};
            t.mRsp && t.mRsp.teamMatchResponse && t.mRsp.teamMatchResponse(o)
        }
    }
    ...
    function oe() {
        this.doSubHandle = function (e, t) {
            var r = e.payload.getStatus();
            if (200 !== r) return m(t.mRsp.errorResponse, r, "team match error"), t.mState.DelTeamMatching(), t.mRsp.teamMatchResultNotify && t.mRsp.teamMatchResultNotify({
                status: r,
                brigades: {},
                roomInfo: {}
            }), 0;
            ...
            var s = e.payload.getBrigadesList(), i = [];
            return s.forEach(function (e) {
                var t = e.getTeamsList(), o = [];
                t.forEach(function (e) {
                    for (var t = e.getPlayerList(), r = 0; r < t.length; r++) o.push({
                        userID: t[r].getUserid(),
                        userProfile: utf8ByteArrayToString(t[r].getUserprofile())
                    })
                });
                var r = {brigadeID: e.getBrigadeid(), playerList: o};
                i.push(r)
            }), t.teamNotifyInfo = {
                status: r,
                brigades: i,
                roomInfo: {}
            }, MatchvsLog.logD(MVS.LgFormat("TeamMatchResultNotifyWork"), t.teamNotifyInfo), MVS.Host.HOST_HOTEL_ADDR = MVS.MsUtil.getHotelUrl(o), t.mState.SetTeamMatching(), t.roomCheckIn(e.payload.getBookinfo(), e.payload.getRoominfo()), 0
        }
    }
    ...
    function se() {
        this.doSubHandle = function (e, t) {
            ...
            t.mRsp && t.mRsp.teamMatchStartNotify && t.mRsp.teamMatchStartNotify(r)
        }
    }
    ...
    function ie() {
        this.doSubHandle = function (e, t) {
            var r = e.payload.getStatus();
            200 !== r && m(t.mRsp.errorResponse, r, "get off line data response error");
            var o = {status: r, frameCount: e.payload.getFramecount() || 0, msgCount: e.payload.getMsgcount() || 0};
            t.mRsp && t.mRsp.getOffLineDataResponse && t.mRsp.getOffLineDataResponse(o)
        }
    }
    ...
    function ae() {
        this.doSubHandle = function (e, t) {
            var r = e.payload.getStatus();
            200 !== r && m(t.mRsp.errorResponse, r, "cancel team match failed"), t.mState.DelTeamMatching(), t.mRsp && t.mRsp.cancelTeamMatchResponse && t.mRsp.cancelTeamMatchResponse({status: r})
        }
    }
    ...
    function ne() {
        this.doSubHandle = function (e, t) {
            ...
            var r = e.payload,
                o = {teamID: r.getTeamid(), userID: r.getUserid(), cpProto: utf8ByteArrayToString(r.getCpproto())};
            t.mRsp && t.mRsp.cancelTeamMatchNotify && t.mRsp.cancelTeamMatchNotify(o)
        }
    }
    ...
    function pe() {
        this.doSubHandle = function (e, t) {
            var r = e.payload.getStatus();
            200 !== r && m(t.mRsp.errorResponse, r, "send team event failed");
            var o = {status: r, dstUserIDs: e.payload.getDstuseridsList() || []};
            t.mRsp && t.mRsp.sendTeamEventResponse && t.mRsp.sendTeamEventResponse(o)
        }
    }
    ...
    function ge() {
        this.doSubHandle = function (e, t) {
            var r = e.payload,
                o = {teamID: r.getTeamid(), userID: r.getUserid(), cpProto: utf8ByteArrayToString(r.getCpproto())};
            t.mRsp && t.mRsp.sendTeamEventNotify && t.mRsp.sendTeamEventNotify(o)
        }
    }
    ...
    function me() {
        this.doSubHandle = function (e, t) {
            var r = e.payload.getStatus();
            200 !== r && m(t.mRsp.errorResponse, r, "kick team member failed");
            var o = {
                status: r,
            ...
            t.mRsp && t.mRsp.kickTeamMemberResponse && t.mRsp.kickTeamMemberResponse(o)
        }
    }
    ...
    function le() {
        this.doSubHandle = function (e, t) {
            ...
            t.mRsp && t.mRsp.kickTeamMemberNotify && t.mRsp.kickTeamMemberNotify(s)
        }
    }
    ...
    var l, p = {ID: 0, token: ""},
        u = {gameID: 0, appkey: "", channel: "", platform: "", deviceID: "", gVersion: "", threshold: 0}, s = [],
        i = function (e) {
            e = String(e);
    ...
    function e() {
        (l = this).mState = new MVS.MvsState, this.mAllPlayers = [], this.mRecntRoomID = 0, this.mWatchRoomID = 0, this.mTeamID = "", this.mNetWorkCallBackImp = null, this.mUserListForJoinRoomRsp = [], this.joinRoomNotifyInfo = {}, this.teamNotifyInfo = null, this.mCntRoomType = MVS.TgRoomType.NRoom, this.mGTWNetwork = null, this.mHotelNetWork = null, this.mWatchNetwrok = null, this.mProtocol = new m.MatchvsProtocol, this.isSpeed = {}, this.nodeDelayInfo = {};
        var g = {}, r = function (o) {
            var e = m.MsUtil.isNeedWSS() ? o.wssProxy : o.gateway,
                t = m.MsUtil.isNeedWSS() ? "" : ":" + m.Host.HOST_GATWAY_PORT, s = m.MsUtil.getWs() + e + t;
            s in l.isSpeed || (l.isSpeed[s] = !0);
            var r = new NetWorkCallBackImp(l), i = new MVS.MatchvsNetWork(s, r);
            g[o.sid] = i;
            var a = new m.MvsTicker, n = 0, p = a.setInterval(function () {
                var e = {sid: o.sid, url: s, tm: Date.now()},
                    t = {gameID: u.gameID, echoData: JSON.stringify(e), gameVersion: u.gVersion},
                    r = l.mProtocol.speed(t);
                i.send(r), n++, s in l.isSpeed && !(5 < n) || (a.clearInterval(p), console.log("clearInterval:" + s))
            }, 500);
            return 0
        }.bind(this);
        this.speedCallBack = function (e, t) {
            var r, o, s = JSON.parse(t), i = Date.now() - s.tm;
            if (s.sid in this.nodeDelayInfo) {
                var a = this.nodeDelayInfo[s.sid];
                "delays" in a || (a.delays = []), a.delays.push(i), a.avgDelay = (r = a.delays, o = 0, r.forEach(function (e) {
                    o += e
                }), Math.round(o / r.length)), 5 <= a.delays.length && (g[s.sid].close(), delete l.isSpeed[s.url])
            }
            "{}" === JSON.stringify(l.isSpeed) && (MatchvsLog.logI("speed completed"), this.getHostList())
        }, this.speed = function () {
            !function (r) {
                s = [];
                var o = m.Host.MAIN_URL + m.APIPATH.NODELIST + "platform=" + u.platform + "&channel=" + u.channel + "&gameid=" + u.gameID + "&userid=123456&virtulIP=",
                    e = (u.platform, u.channel, u.gameID, {
                        onMsg: function (e) {
                            var t = JSON.parse(e);
                            MatchvsLog.logI("[getSetList][" + o + " ]" + e), t.status && t.data && 200 === t.status ? (s.push(t.data.sets), r(t.data.sets, null)) : r(null, {
                                errCode: -1,
                                errMsg: "getSetList data error"
                            })
                        }, onErr: function (e, t) {
                            MatchvsLog.logE("getSetList failed errcode:" + e + " errmsg:" + t), r(null, {
                                errCode: e,
                                errMsg: t
                            })
                        }
                    });
                new MVS.MatchvsHttp(e).get(o)
            }(function (e, t) {
                null != e && (l.nodeDelayInfo = {}, e.forEach(function (e) {
                    l.nodeDelayInfo[e.sid] = e, r(e)
                }))
            })
        };
        var i = function (o, e) {
            if (!e) return o({status: 0}, null), 0;
            if (m.MsUtil.isEmptyObj(l.nodeDelayInfo)) return o({status: -1}, null), -1;
            var t = m.Host.MAIN_URL + m.APIPATH.SCHEDULE,
                r = {channel: u.channel, platform: u.platform, gameID: Number(u.gameID), userID: 123456}, s = [],
                i = l.nodeDelayInfo;
            for (var a in i) i[a].delays.sort(), s.push({
                setId: i[a].sid,
                gateWay: i[a].gateway,
                avgLatency: i[a].avgDelay,
                speedTimes: 5,
                minLatency: i[a].delays[0],
                maxLatency: i[a].delays[i[a].delays.length - 1],
                succRate: 1
            });
            var n = {params: r, speeds: s, lastSet: 100, threshold: 0, selectSet: 0}, p = {
                onMsg: function (e) {
                    var t = JSON.parse(e);
                    if (200 === t.status) {
                        var r = t.data.best_sets[0];
                        t.data.sets.forEach(function (e) {
                            r === e.sid && (m.Host.HOST_GATWAY_ADDR = m.MsUtil.getGtwUrl(e.gateway, e.wssProxy))
                        })
                    }
                    o(t, null)
                }, onErr: function (e, t) {
                    o(null, {errCode: e, errMsg: t})
                }
            };
            return new MVS.MatchvsHttp(p).post(t, n), 0
        };
        this.getNodeList = function () {
            if ("{}" === JSON.stringify(this.nodeDelayInfo)) return null;
            var e = [];
            for (var t in this.nodeDelayInfo) {
                var r = this.nodeDelayInfo[t].avgDelay,
                    o = this.nodeDelayInfo[t].name + "-" + this.nodeDelayInfo[t].area;
                e.push({nodeID: this.nodeDelayInfo[t].sid, latency: r, area: o})
            }
        ...
        var a = function (e) {
            if (m.MsUtil.isEmptyObj(this.nodeDelayInfo)) return -29;
            if (0 !== e.nodeID) {
                var t = this.nodeDelayInfo[e.nodeID];
                if (void 0 === t) return -29;
                m.Host.HOST_GATWAY_ADDR = m.MsUtil.getGtwUrl(t.gateway, t.wssProxy)
            }
            null !== this.mGTWNetwork && this.mGTWNetwork.close();
            var r = i(function (e, t) {
                null == t ? n(p.ID, p.token, p.deviceID) : MatchvsLog.logE("node schedule error:" + JSON.stringify(t))
            }.bind(this), !1);
            return 0 !== r ? r : 0
        }.bind(this);
        this.changeNode = function (e) {
            ...
            return 0 !== t ? t : a(e)
        }, this.init = function (e, t, r, o, s, i, a) {
            return void 0 === t || "" === t ? (console.error("[ERR] ill pars ,channel:" + t), -1) : void 0 === r || "" === r ? (console.error("[ERR] ill pars ,platform:" + r), -1) : void 0 === o || 0 === o ? (console.error("[ERR] ill pars ,gameID:" + o), -1) : void 0 === s || "" === s ? (console.error("[ERR] ill pars ,appKey:" + s), -1) : (MVS.Game.id = o, MVS.mtaReport && MVS.mtaReport.Report("init"), this.mRsp = e, u.channel = t, u.platform = r, u.gVersion = i || 1, u.appkey = s, u.gameID = o, this.mState.SetIniting(), this.mProtocol.init(), void 0 === a ? this.getHostList() : (u.threshold = a, this.speed()), 0)
        }, this.premiseInit = function (e, t, r, o) {
            return void 0 === t || "" === t ? -1 : (this.mRsp = e, MVS.Game.id = r, u.gameID = r, u.appkey = o, 0 <= t.indexOf("wss://") || 0 <= t.indexOf("ws://") ? MVS.Host.HOST_GATWAY_ADDR = t : MVS.Host.HOST_GATWAY_ADDR = m.MsUtil.getWs() + t, this.mState.SetInit(), this.mRsp.initResponse(200), 0)
        }, this.reconnect = function () {
            var e = this.mState.ReconnectCheck();
            if (0 !== e) return e;
            if (0 === this.mState.HaveLogin()) {
                if ("0" !== this.mRecntRoomID) {
                    this.mState.SetReconnecting();
                    var t = new MsRoomJoin(MsEnum.JoinRoomType.reconnect, p.ID, this.mRecntRoomID, u.gameID, 0, 0, 0, "reconnect", [{name: "MatchVS"}]),
                        r = this.mProtocol.joinRoomSpecial(t);
                    this.mGTWNetwork.send(r), this.mRecntRoomID = "0"
                }
                return "0" !== this.mRecntTeamID && (this.joinTeam({
                    teamID: this.mRecntTeamID,
                    password: "",
                    userProfile: "reconnect",
                    joinType: 1
                }), this.mRecntTeamID = "0"), 0
            }
            return 0 === u.gameID || "" === u.appkey ? -1 : (void 0 !== this.mGTWNetwork && null !== this.mGTWNetwork && this.mGTWNetwork.close(), this.mState.SetReconnecting(), this.login(p.ID, p.token, u.deviceID))
        };
        var n = function (e, t, r) {
            p.ID = e, this.mUserID = e, p.token = t, u.deviceID = r, MVS.ccReport && MVS.ccReport.init(), MVS.ccReport && MVS.ccReport.login(u.gameID), void 0 !== this.mGTWNetwork && null !== this.mGTWNetwork && this.mGTWNetwork.close(), this.mNetWorkCallBackImp = new NetWorkCallBackImp(this), this.mGTWNetwork = new MVS.MatchvsNetWork(MVS.Host.HOST_GATWAY_ADDR, this.mNetWorkCallBackImp);
            var o = this.mProtocol.login(p.ID, p.token, u.gameID, u.appkey, u.deviceID);
            this.mState.SetLogining(), this.mGTWNetwork.send(o), MatchvsLog.logI("login,userID" + p.ID + ", token:" + p.token)
        }.bind(this);
        this.login = function (r, o, s, e) {
            if (void 0 === r || "" === r || 0 === r) return console.error("[ERR] ill pars ,userID:" + r), -1;
            if (void 0 === o || "" === o) return console.error("[ERR] ill pars ,token:" + o), -1;
            p.ID = r, this.mUserID = r, p.token = o, u.deviceID = s || "0";
            var t = this.mState.LoginCheck();
            return 0 !== t ? t : (new MVS.AppKeyCheck).isInvailed(u.appkey) ? e ? a({nodeID: e}) : 0 !== (t = i(function (e, t) {
                null == t ? n(r, o, s) : MatchvsLog.logE("node schedule error:" + JSON.stringify(t))
            }.bind(this), e && 0 !== e)) ? t : 0 : -26
            ...
            var s = {
                ...
                owner: 0
            }, i = {userID: p.ID, userProfile: t}, a = this.mProtocol.roomCreate(u.gameID, s, i, r);
            ...
            return this.logout(""), this.mState.ReSet(), this.mRsp = new MatchvsResponse, MatchvsLog.logI("unInit "), 0
            ...
            var r = this.mProtocol.roomCheckIn(e, t, p.ID, u.gameID);
            ...
            if (512 < t.length) return -21;
            var o = new MsRoomJoin(MsEnum.JoinRoomType.joinRandomRoom, p.ID, 0, u.gameID, e, 0, 0, t, [{name: "matchvs"}]),
            ...
            if (e.maxPlayer > MVS.Config.MAXPLAYER_LIMIT || e.maxPlayer < MVS.Config.MINPLAYER_LIMIT) return -20;
            var s = new MsRoomJoin(MsEnum.JoinRoomType.joinRoomWithProperty, p.ID, 1, u.gameID, e.maxPlayer, e.mode, e.canWatch, t, e.tags, e.visibility, e.roomProperty),
                i = this.mProtocol.joinRoomWithProperties(s, r);
            return this.mState.SetJoinRooming(), this.mGTWNetwork.send(i), 0
        }, this.joinRoom = function (e, t, r) {
            var o = this.mState.InRoomCheck();
            if (o < 0) return o;
            if (!/^[0-9]+$/.test(e)) return -1;
            var s = String(e).trim();
            if (0 === s || "" === s) return -1;
            var i = new MsRoomJoin(r ? MsEnum.JoinRoomType.reconnect : MsEnum.JoinRoomType.joinSpecialRoom, p.ID, e, u.gameID, 0, 0, 0, t, [{name: "MatchVS"}]),
                a = this.mProtocol.joinRoomSpecial(i);
            return this.mState.SetJoinRooming(), this.mGTWNetwork.send(a), MatchvsLog.logI("join room"), 0
        }, this.joinOver = function (e) {
            var t = this.mState.HaveInRoom();
            if (t < 0) return t;
            if (1024 < e.length) return -21;
            var r = this.mProtocol.joinOver(u.gameID, this.mRoomInfo.getRoomid(), stringToUtf8ByteArray(e), p.ID);
            ...
            var o = this.mProtocol.leaveRoom(u.gameID, p.ID, r, e);
            ...
            var o = this.mProtocol.kickPlayer(e, p.ID, this.mRoomInfo.getRoomid(), t);
            return this.mGTWNetwork.send(o), 0
        }, this.setFrameSync = function (e, t, r) {
            void 0 === r && (r = {cacheFrameMS: 0});
            ...
            var t = this.mState.HaveInRoom();
            if (t < 0) return t;
            var r = this.mProtocol.joinOpen(u.gameID, p.ID, this.mRoomInfo.getRoomid(), e);
            return this.mGTWNetwork.send(r), 0
        }
    }
    ...
    e.prototype.logout = function (e) {
        ...
        return this.mGTWNetwork && this.mGTWNetwork.close(), this.mHotelNetWork && this.mHotelNetWork.close(), 0
    }, e.prototype.heartBeat = function () {
        var e;
        if (void 0 !== u.gameID && "" !== u.gameID && 0 !== u.gameID && (e = void 0 === l.mRoomInfo ? 0 : l.mRoomInfo.getRoomid(), !l.mState.IsLoginOuting())) {
            var t = l.mProtocol.heartBeat(u.gameID, e);
            l.mGTWNetwork.send(t), MatchvsLog.logD("gateway heartBeat:")
        }
    }, e.prototype.sendEvent = function (e, t) {
        var r = this.mState.HaveInRoom();
        if (0 !== r) return {sequence: this.mProtocol.seq - 1, result: r};
        if (1024 < e.length) return -21;
        var o = this.mProtocol.broadCast(this.mRoomInfo.getRoomid(), [this.mUserID], 1, 0, stringToUtf8ByteArray(e, t));
        return this.mHotelNetWork.send(o), {sequence: this.mProtocol.seq - 1, result: 0}
    }, e.prototype.sendEventEx = function (e, t, r, o, s) {
        var i = this.mState.HaveInRoom();
        if (0 !== i) return {sequence: this.mProtocol.seq - 1, result: i};
        if ("string" != typeof t && s && !0 !== s) return {sequence: this.mProtocol.seq - 1, result: -1};
        ...
        return this.mHotelNetWork.send(a), {sequence: this.mProtocol.seq - 1, result: 0}
        ...
        if (l.mState.IsLeaveRooming()) return 0;
        l.mState.SetLogin(), l.mState.SetInRoom();
        var e = l.mProtocol.hotelHeartBeat(u.gameID, l.mRoomInfo.getRoomid(), p.ID);
        l.mHotelNetWork.send(e), MatchvsLog.logD("hotel heartBeat:")
    }, e.prototype.registerUser = function () {
        MVS.mtaReport && MVS.mtaReport.Report("registerUser");
        var e = this.mState.HaveInit();
        if (0 !== e) return e;
        var t = u.channel, r = "regUserInfo" + t + u.platform, o = u.gVersion, s = LocalStore_Load(r);
        if (s) {
            var i = JSON.parse(s);
        ...
        var a = m.APIPATH.REGISTERUSER,
            n = MVS.Host.VS_OPEN_URL + a + "?mac=0&deviceid=javascript&channel=" + t + "&pid=13&version=" + o, p = {
                rsp: this.mRsp.registerUserResponse, onMsg: function (e) {
                    var t = JSON.parse(e);
                    MatchvsLog.logI("[registerUser][ " + n + " ]" + e), 0 === t.status ? (LocalStore_Save(r, e), this.rsp(new MsRegistRsp(t.status, t.data.userid, t.data.token, t.data.nickname, t.data.avatar))) : this.rsp(new MsRegistRsp(t.status, 0, "err", e, "err")), MVS.mtaReport && MVS.mtaReport.Report("registerUserResponse")
                }, onErr: function (e, t) {
                    this.rsp(new MsRegistRsp(0 === e ? -1 : e, 0, "err", t, "err"))
                }
            };
        return MatchvsLog.logI("reg a new user"), new MVS.MatchvsHttp(p).get(n), 0
    }, e.prototype.getHostList = function () {
        var e = u.gameID, t = u.channel, r = u.platform, o = m.APIPATH.HOSTLIST, s = MVS.MsUtil.isNeedWSS(),
            i = MVS.Host.MAIN_URL + o + "?mac=0&gameid=" + e + "&channel=" + t + "&platform=" + r + (s ? "&useWSSProxy=1" : ""),
            a = this, n = {
                onMsg: function (e) {
                    var t = JSON.parse(e);
                    if (MatchvsLog.logI("[getHostList][ " + i + " ]" + e), 200 === t.status) {
                        a.mState.SetInit();
                        var r = "https://";
                        MVS.Host.VS_USER_URL = r + t.data.vsuser, MVS.Host.HOST_GATWAY_ADDR = m.MsUtil.getGtwUrl(t.data.engine, t.data.wssProxy), MVS.Host.CMSNS_URL = r + t.data.cmsns, MVS.Host.VS_OPEN_URL = r + t.data.vsopen, MVS.Host.VS_PAY_URL = r + t.data.vspay, MVS.Host.VS_PRODUCT_URL = r + t.data.VS_PRODUCT_URL
                    }
        ...
        var r = this.mState.HaveInRoom();
        if (0 !== r) return r;
        var o = this.mProtocol.setRoomProperty(u.gameID, p.ID, e, t);
        return this.mGTWNetwork.send(o), 0
        ...
        if (512 < t.length) return -21;
        this.mWatchRoomID = e;
        var o = this.mProtocol.joinWatchRoom(u.gameID, p.ID, this.mWatchRoomID, t);
        ...
        var r = this.mProtocol.enterLiveRoom(e, u.gameID, p.ID, this.mWatchRoomID, 0);
        return this.mWatchNetwrok.send(r), 0
    }, e.prototype.liveHeartBeat = function () {
        var e = l, t = e.mRecntRoomID, r = e.mProtocol.liveHeartBeat(u.gameID, t, p.ID);
        return e.mWatchNetwrok.send(r), MatchvsLog.logI("live heartBeat"), 0
    }, e.prototype.leaveWatchRoom = function (e) {
        var t = this.mState.HaveLogin();
        if (0 !== t) return t;
        var r = this.mWatchRoomID, o = this.mProtocol.leaveWatchRoom(u.gameID, p.ID, r, e);
        ...
        if (0 !== t) return t;
        var r = this.mWatchRoomID, o = this.mProtocol.setLiveOffset(u.gameID, r, p.ID, e);
        ...
        var r = this.mWatchRoomID, o = 0, s = this.mState.HaveLogin();
        if (0 !== s) return s;
        ...
        if (0 !== s) return s;
        var i = this.mProtocol.changeRoleProto(p.ID, u.gameID, r, o, e);
        return this.mGTWNetwork.send(i), 0
    }, e.prototype.setReconnectTimeout = function (e) {
        var t = Number(e), r = this.mState.HaveLogin();
        if (0 !== r) return r;
        if (t < -1 || 600 < t) return -27;
        var o = this.mProtocol.setReconnectTimeout(p.ID, e);
        return this.mGTWNetwork.send(o), 0
    }, e.prototype.setTeamReconnectTimeout = function (e) {
        var t = Number(e), r = this.mState.HaveLogin();
        if (0 !== r) return r;
        if (t < -1 || 600 < t) return -27;
        var o = this.mProtocol.setTeamReconnectTimeout(p.ID, e);
        return this.mGTWNetwork.send(o), 0
        ...
        var r = {
            ...
            owner: 0,
            visibility: e.visibility,
            teamProperty: e.teamProperty
        }, o = {userID: p.ID, userProfile: e.userProfile}, s = this.mProtocol.CreateTeam(u.gameID, r, o);
        ...
        if (512 < e.userProfile.length) return -21;
        var r = 0;
        e.joinType && (r = e.joinType), this.mTeamID = e.teamID;
        var o = {
            gameID: u.gameID,
            teamID: e.teamID,
            password: e.password,
            player: {userID: p.ID, userProfile: e.userProfile},
            joinType: r
        }, s = this.mProtocol.JoinTeam(o);
        return this.mGTWNetwork.send(s), 0
    }, e.prototype.leaveTeam = function () {
        var e = this.mState.HaveLogin();
        if (0 !== e) return e;
        var t = {gameID: u.gameID, userID: p.ID, teamID: this.mTeamID}, r = this.mProtocol.LeaveTeam(t);
        return this.mGTWNetwork.send(r), 0
    }, e.prototype.setTeamProperty = function (e) {
        var t = this.mState.HaveLogin();
        if (0 !== t) return t;
        var r = {gameID: u.gameID, userID: p.ID, teamID: this.mTeamID, teamProperty: e},
            o = this.mProtocol.SetTeamProperty(r);
        return this.mGTWNetwork.send(o), 0
    }, e.prototype.setTeamUserProfile = function (e) {
        var t = this.mState.HaveLogin();
        if (0 !== t) return t;
        var r = {gameID: u.gameID, teamID: this.mTeamID, userID: p.ID, userProfile: e},
            o = this.mProtocol.setTeamUserProfile(r);
        return this.mGTWNetwork.send(o), 0
        ...
        var t = this.mState.HaveInRoom();
        if (0 !== t) return t;
        var r = {gameID: u.gameID, roomID: this.mRecntRoomID + "", cacheFrameMS: e},
        ...
        var t = {gameID: u.gameID, teamID: this.mTeamID, userID: p.ID, cpProto: e.cpProto},
        ...
        var t = this.mState.HaveInTeam();
        if (0 !== t) return t;
        var r = {gameID: u.gameID, teamID: this.mTeamID, userID: p.ID, dstuserID: e.userID, cpProto: e.cpProto},
            o = this.mProtocol.KickTeamMember(r);
        return this.mGTWNetwork.send(o), 0
    }, window.MatchvsEngine = e, m.MatchvsEngine = e
}(MVS || {});
try {
