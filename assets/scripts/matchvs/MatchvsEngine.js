 ...
 * @returns {*|void|number}
 */
NetWorkEngine.prototype.getRoomListEx = function (msRoomFilterEx) {
    var result = mvs.engine.getRoomListEx(msRoomFilterEx);
    return result;
};

NetWorkEngine.prototype.createRoom = function (createRoomInfo,userProfile,watchSet) {
    var result = mvs.engine.createRoom(createRoomInfo,userProfile,watchSet);
    return result;
};
