 ...
 * @param error
 */
MatchvsResponse.prototype.getRoomListExResponse = function (msGetRoomListExRsp) {
    this.context.node.emit(msg.MATCHVS_ROOM_LIST_EX,msGetRoomListExRsp);

};

MatchvsResponse.prototype.createRoomResponse = function (msCreateRoomRsp) {
    this.context.node.emit(msg.MATCHVS_CREATE_ROOM,msCreateRoomRsp);
